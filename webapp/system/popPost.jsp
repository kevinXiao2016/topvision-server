...
Ext.onReady(function(){
    ...
    var root = new Ext.tree.AsyncTreeNode({text: 'Post Tree', draggable:false, id:'source'});
...
function okClick() {
	...
	if(item == null || item == ''){
		window.parent.showMessageDlg("@COMMON.tip@", "@WorBench.addPostTip@");
		return 
	}
	window.parent.ZetaCallback = {type:'ok', selectedItemId : item.id, selectedItemText : item.text};
	window.parent.closeWindow('postDlg');
}
...
<body class="openWinBody">
	<div class="edge10">
		<p class="blueTxt pB10">@td.postList@</p>
		<div id="postTree" class="threeFeBg" style=" overflow:auto;"></div>
		<div class="noWidthCenterOuter clearBoth">
		     <ol class="upChannelListOl pB0 pT20 noWidthCenter">
		         <li><a id=okBt onclick="okClick()" href="javascript:;" class="normalBtnBig"><span><i class="miniIcoSaveOK"></i>@button.ok@</span></a></li>

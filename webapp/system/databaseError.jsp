...
<title>@platform/sys.databaseError@</title>
<style type="text/css">
			...
			<div id="step0">
				<div class="edge10">
						<div class="zebraTableCaption">
					     <div class="zebraTableCaptionTitle"><span>@platform/sys.databaseError@</span></div>
						        ...
						        <tbody>
                                    ...
                                    <tr class="darkZebraTr">
                                        <td class="withoutBorderBottom">
                                            <span class="pL40">@platform/database.error.cause1@</span>
                                        </td>
                                    </tr>
                                    <tr class="darkZebraTr">
                                        <td class="withoutBorderBottom">
                                            <span class="pL40">@platform/database.error.cause2@</span>
                                        </td>
                                    </tr>
                                    <tr class="darkZebraTr">
                                        <td class="withoutBorderBottom">
                                            <span class="pL40">@platform/database.error.cause3@</span>
                                        </td>
                                    </tr>
						            <tr>
						            ...
						            <tr>
						            	<td class="withoutBorderBottom">
						            		<span class="pL20 pR20 orangeTxt">@platform/database.error.remark@</span>
						            	</td>
						            </tr>
						        </tbody>
						    </table>

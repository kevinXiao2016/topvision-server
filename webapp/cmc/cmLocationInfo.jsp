...
var entityIp = '<s:property value="cmTopologyInfo.ip"/>';
function cancleClick(){
	window.parent.closeWindow('showCmLocationDlg');
}
function viewCmcSnap(){
	window.parent.addView('entity-' + cmcId, "CCMTS" + '[' + cmcMac + ']', 'entityTabIcon',
			'/cmc/channel/showUpChannelList.tv?cmcId=' + cmcId);	 
	cancleClick()
}

function viewOltSnap(){
	window.parent.addView('entity-' + entityId,
			I18N.CMC.text.equipment+ '[' + entityIp + ']',
...
<body class=POPUP_WND
	...
	<fieldset style="background-color: #ffffff; width: 580px; height: 240px;" align="center">
				...
				<td>
					<div>
						<v:RoundRect
							...
							<div align="center" style="padding-top: 2px;">
								IP：<a href="#" onClick='viewOltSnap()'><s:property
										value="cmTopologyInfo.ip" /></a>
							</div>
						</v:RoundRect>
						<v:RoundRect
						...
						<v:RoundRect
							...
							stroked="false">
							<div align="center" style="padding-top: 5px;">
								<fmt:message bundle='${cmc}' key='I18N.CMC.label.Pon'/>
						...
						<v:RoundRect
							...
							<div align="center" style="padding-top: 2px;">
								<a href="#" onClick='viewCmcSnap()'><s:property
										value="cmcAttribute.nmName" /></a>
							</div>
							<div align="left" style="padding-top: 2px; padding-left: 5px;"><fmt:message bundle='${cmc}' key='CMC.text.mac'/>:</div>
							<div align="center" style="padding-top: 2px;">
						...
						<v:RoundRect
							...
							<div align="left" style="padding-top: 2px; padding-left: 5px;"><fmt:message bundle='${cmc}' key='CCMTS.entityStatus'/>:</div>
							<div align="center" style="padding-top: 2px;">

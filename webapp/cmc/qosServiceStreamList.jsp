...
Ext.onReady(function () {
	...
	var columns = [
		...
		{header: I18N.CMC.title.adminStatus, width: 100, sortable:true, align : 'center', dataIndex: 'serviceAdminStatus'},
       	{header: I18N.CMC.title.property, width: 100, sortable:true, align: 'center', dataIndex: 'serviceQosProfile'},
       	{header: I18N.CMC.title.createTime, width: 100, sortable:true, align: 'center', dataIndex: 'serviceCreateTime'},
       	{header: I18N.CMC.title.inOctets, width: 100, sortable: true, align: 'center', dataIndex: 'serviceInOctets'},	
		{header: I18N.CMC.title.inPackets, width: 100, sortable: true, align: 'center', dataIndex: 'serviceInPackets'},
...
function cancelClick() {
	window.top.closeWindow('qosServiceStream');
}
</script>
</head>
			...
			<tr>
				<td valign=top align=right>
					<button class=BUTTON75 onMouseOver="this.className='BUTTON_OVER75'"
						onMouseOut="this.className='BUTTON75'" onclick="cancelClick()"><fmt:message bundle="${cmcRes}" key="CMC.button.close"/></button>
				</td>
			</tr>
		</table>
  </div>

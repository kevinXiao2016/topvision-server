...
<script type="text/javascript">
    ...
    function exportFile(){
    	exportExcel(grid,'@network/CcmtsUser@');
    }
    ...
    $(function() {
        ...
        store = new Ext.data.JsonStore({
            url : '/cmcperf/loadCmtsUsers.tv',
            root : 'data',
            totalProperty : 'rowCount',
            remoteSort : true,
            fields : [ 'cmcId','entityId','parentId','displayName','cmNumTotal','topCcmtsSysMacAddr', 'cmcName',{"name":"dt","mapping":'dtStr'}]
        });

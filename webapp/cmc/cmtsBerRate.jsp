...
<script type="text/javascript">
    ...
    function exportFile(){
    	exportExcel(grid,'@network/NETWORK.ccmtsUsBerTop10@');
    }
    ...
    $(function() {
        ...
        store = new Ext.data.JsonStore({
            url : '/cmcperf/loadCmtsBerRate.tv',
            root : 'data',
            totalProperty : 'rowCount',
            remoteSort : true,
            fields : [ 'cmcId','parentId','uplinkDevice','ip',{"name":"topCcmtsSysMacAddr","mapping":'macAddress'},'cmcName','ucerRate','ccerRate','displayName', 
                       {"name":"channelIndex","mapping":'cmcPortName'},{"name":"collectTime","mapping":'dtStr'} ]
        });

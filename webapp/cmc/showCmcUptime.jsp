...
<body>
	<div id=deviceUpTimer align=center  class="deviceUpTimer">
		...
		<div class="hourDiv">
			<img id="hour2" border=0 hspace=3 src="/images/0.png"/>
			<img id="hour1" border=0 hspace=3 src="/images/0.png"/>
			<span class="timeTxt">@ENTITYSNAP.deviceUpTime.hour@</span>
		</div>		
			
		<div class="minuteDiv">
			<img id="min2" border=0 hspace=3 src="/images/0.png"/>
			<img id="min1" border=0 hspace=3 src="/images/0.png"/>
			<span class="timeTxt">@ENTITYSNAP.deviceUpTime.minute@</span>
		</div>
		
		<div class="secondsDiv">
			<img id="sec2" border=0 hspace=3 src="/images/0.png"/>
			<img id="sec1" border=0 hspace=3 src="/images/0.png"/>

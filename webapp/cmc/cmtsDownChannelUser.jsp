...
<script type="text/javascript">
    ...
    function exportFile(){
    	exportExcel(grid,'@network/CcmtsDownChannelUser@');
    }
    ...
    $(function() {
        	...
        	columns: [
   	          {
   	              ...
   	              header : "@resources/WorkBench.AllUserNum@",
   	              dataIndex : 'cmNumTotal',
   	              align:'center',
   	              sortable:true
   	          }, {
   	              header : "@resources/WorkBench.OfflionUserNum@",
   	              dataIndex : 'cmNumOffline',
   	              align:'center',
   	              sortable:true
   	          },{
   	              header : "@checkTime@",
        ...
        store = new Ext.data.JsonStore({
            url : '/cmcperf/loadCmtsUsers.tv?direction=down',
            root : 'data',
            totalProperty : 'rowCount',
            remoteSort : true,
            fields : [ 'cmcId','entityId','parentId',{"name":"channelIndex","mapping":'cmcPortName'},'displayName','cmNumTotal','cmNumOffline','topCcmtsSysMacAddr', 'cmcName',{"name":"dt","mapping":'dtStr'}]
        });

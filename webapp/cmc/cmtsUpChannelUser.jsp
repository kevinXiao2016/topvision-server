...
<script type="text/javascript">
    ...
    function exportFile(){
    	exportExcel(grid,'@network/CcmtsUpChannelUser@');
    }
    ...
    $(function() {
        ...
        store = new Ext.data.JsonStore({
            url : '/cmcperf/loadCmtsUsers.tv?direction=up',
            root : 'data',
            totalProperty : 'rowCount',
            remoteSort : true,
            fields : [ 'cmcId','entityId',{"name":"channelIndex","mapping":'cmcPortName'},'parentId','displayName','cmNumTotal','cmNumOffline','topCcmtsSysMacAddr', 'cmcName',{"name":"dt","mapping":'dtStr'}]
        });

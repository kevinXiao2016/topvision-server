...
var operationDevicePower = <%=uc.hasPower("operationDevice")%>;
    ...
    // ---------------------函数定义------------------------------
    function setLoadBalPol(_entityId,policyType,disSections){
    	$.ajax({
            url: '/cmc/loadbalance/addLoadBalPolicy.tv',
            type: 'POST',
            cache:false,
            dataType:'json',
            data:{
            ...
            success: function(data) {
                if(data.success){
                    ...
                    window.top.showMessageDlg("@tip@", data.msg);
                }
...
function okClick(){
    ...
    if(policyType==3&&disSections.length==0){
        ...
        if(!checkDisSectionsStartEndTime()){
    		...
    		setLoadBalPol(_entityId,policyType,getDisSectionsToStr());	
    	}
    }
}
function closeWindow(){
    window.top.closeWindow('addLoadBalPolicyWin');    
}
</script>
</head>
	<body class="openWinBody">
		...
		<div class="openWinHeader">
			<div class="openWinTip">@loadbalance.addLoadBalancePolicy@</div>
		...
		<div class="edge10">
			<table class="mCenter zebraTableRows" >
			    ...
			    <tr class="darkZebraTr">
			        ...
			        <td>
			            <select id="policy_type" class="normalSel w220">
			    ...
			    <tr id="period_tr" style="visibility:hidden;">
			        ...
			        <div style="height:80px;overflow: auto;" id="period_ctx">
			            ...
			            <img src="/images/add.png" align="absmiddle" style="cursor: pointer;" id="btn_add_period" nm3kTip="@COMMON.add@" class="nm3kTip" />
			            </div>
			        </div>
			        </td>
			    </tr>

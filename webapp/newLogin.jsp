...
.broadBg{ width:100%; height:478px; overflow:hidden; background:url(images/loginBroadBg.png) no-repeat center 0; position:relative; top:160px;}
.containerLoginBox{ width:583px; height:358px; margin:84px auto 0px; position:relative;}
.loginBox{ width:583px; height:358px; overflow:hidden; position:relative; background:url(images/loginBox.png) no-repeat;}
		...
		<div class="broadBg">
		    <div class="containerLoginBox">
		  	   <div class="loginBox">
					...
					<input id="logonBt" type="image" name="imageField" src="images/loginBtn.png" width="146" height="43" class="loginBtn" onclick="logonClick()" />			
			   </div>			  
			</div>
		</div>		
	</div>
...
<script type="text/javascript">
	$(function(){
	    ...
	    if(!bro.msie || bro.version < 7){//如果是ie7以下浏览器;
	    	$("#ieTips").fadeIn('slow');   	
	    }

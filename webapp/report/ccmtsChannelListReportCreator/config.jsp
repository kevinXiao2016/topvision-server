...
function commit(){
	...
	var conditionMap = zetaCallback.conditionMap;
		conditionMap.upModuleDisplayable = Ext.get("upModuleDisplayable").dom.checked;
		conditionMap.downModuleDisplayable = Ext.get("downModuleDisplayable").dom.checked;
				...
				<tr>
					...
					<td>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>@report.folder@
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>@report.oltName@
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>OLT_IP
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>@report.pon@
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>@report.ccmtsName@
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>CC_MAC
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>@report.ccmtsUpChannelNum@
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>@report.ccmtsDownChannelNum@
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox" id="upModuleDisplayable"/>@report.ccmtsUpChannelModule@
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox" id="downModuleDisplayable"/>@report.ccmtsDownChannelModule@
						</div>
					</td>
				</tr>
				<tr class="darkZebraTr">

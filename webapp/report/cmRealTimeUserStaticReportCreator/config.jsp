...
<script type="text/javascript">
	...
	function commit() {
		...
		//报表的标题以及签名
		if (!ReportTaskUtil.check(zetaCallback))
			return;
	...
	<body class=openWinBody>
		...
		<div class="edgeTB10LR20 pT40">
			<table class="zebraTableRows" cellpadding="0" cellspacing="0" border="0">
				<tbody>
					<tr>
						<td class="rightBlueTxt" width="140">@report.reportTitle@<span class="required">*</span>:</td>
						<td><input id="title" type="text" maxlength=32 class="normalInput" /></td>
					</tr>
					<tr class="darkZebraTr">
						<td class="rightBlueTxt">@report.reportAuthor@<span class="required">*</span>:</td>
						<td><input id="author" type="text" maxlength=32 class="normalInput"
					value="<%=CurrentRequest.getCurrentUser().getUser().getFamilyName()%>" /></td>
					</tr>
					<tr>
						<td class="rightBlueTxt">@report.reportType@<span class="required">*</span>:</td>
						<td>
							<input type="checkbox" disabled="disabled" id="excelSupport" checked="checked" />EXCEL 
							<input type="checkbox" disabled="disabled" id="pdfSupport" style="margin-left: 30px;display:none" />
							<input type="checkbox" disabled="disabled" id="htmlSupport" style="margin-left: 30px;display:none" />
						</td>
					</tr>
				</tbody>
			</table>

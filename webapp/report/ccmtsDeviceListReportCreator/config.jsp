...
function commit(){
	...
	var conditionMap = zetaCallback.conditionMap;
		...
		conditionMap.locationDisplayable = Ext.get("locationDisplayable").dom.checked;
		conditionMap.dutyDisplayable = Ext.get("dutyDisplayable").dom.checked;
		conditionMap.createTimeDisplayable = Ext.get("createTimeDisplayable").dom.checked;
				...
				<tr>
					...
					<td>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>@report.deviceName@
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>地域
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>IP
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>@label.mac@
						</div>
						<div class="floatLeftDiv">
							<input checked="checked" disabled="disabled" type="checkbox"/>@report.deviceType@
						</div>
						<div class="floatLeftDiv">
							<input type="checkbox" id="locationDisplayable"/>@label.location@
						</div>
						<div class="floatLeftDiv">
							<input type="checkbox" id="dutyDisplayable"/>@report.contactor@
						</div>
						<div class="floatLeftDiv">
							<input type="checkbox" id="createTimeDisplayable"/>@report.createTime@
						</div>
					</td>
				</tr>
				<tr class="darkZebraTr">
					...
					<td>
						<div class="floatLeftDiv">
							<input name="sortInfo" type="radio" value="nmName"/>@label.entityName@
						</div>
						<div class="floatLeftDiv">
							<input name="sortInfo" type="radio" value="topCcmtsSysMacAddr"/>@label.mac@
						</div>
						<div class="floatLeftDiv">
							<input name="sortInfo" type="radio" value="cmcDeviceStyle" checked="checked"/>@report.deviceType@
						</div>
					</td>
				</tr>
				<tr>

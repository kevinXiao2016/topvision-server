...
function exportExcelClick() {
	var stTime = '<s:property value="stTime"/>',
		...
		url = "/cmc/report/exportCcmtsDownChlDetailToExcel.tv";
...
<body class="whiteToBlack">
	...
	<div class="report-content-div" id="pageview">
		<h1>@report.ccmtsDownChlFlowDetail@</h1>
		...
		<table class="reportTable" id="reportTable">
			<thead>
				<tr>
					...
					<th class="nowrap">@report.ds@</th>
					<th class="nowrap">@report.modulationProfile@</th>
					<th>@report.dsFlowMax@</th>
					<th>@report.dsUsageMax@</th>
					<th>@report.dsUsageAve@</th>
			...
			<tbody>
				<%
				Map<String, List<CcmtsChlFlowDetail>> statUpChlFlowDetail = (Map<String, List<CcmtsChlFlowDetail>>) request.getAttribute("statDownChlFlowDetail");

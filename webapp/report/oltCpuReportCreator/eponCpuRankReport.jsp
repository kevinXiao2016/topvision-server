...
//查询按钮
function queryClick() {
	queryForm.action = '/epon/report/showEponCpuRankReport.tv';
...
function exportExcelClick() {
	window.location.href="/epon/report/exportCpuRankReportToExcel.tv"; 
}
$(function(){
	new Ext.SplitButton({
				...
				<tr>
					...
					<td>
						<div class="floatLeftDiv">
							...
							<label for="ipSort">@report.cpuUse@</label>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<div class="floatLeftDiv">
							<input <s:if test="cpuDisplayable">checked</s:if> disabled = "disabled" id="cpuDisplayable" name="cpuDisplayable" type=checkbox value="true" />
							<label for="cpuDisplayable">@report.cpuUse@</label>
						</div>
						<div class="floatLeftDiv">
		...
		<table class="reportTable" id="reportTable">
			<thead>
				<tr>
					...
					<s:if test="cpuDisplayable">
						<th class="nowrap">@report.cpuUse@</th>
					</s:if>
			...
			<tbody>
				<s:iterator value="performanceRank">
					<tr>
						...
						<s:if test="cpuDisplayable">
							<td class="nowrap"><s:property value="CPU_p" /></td>
						</s:if>
						<s:if test="snapTimeDisplayable">

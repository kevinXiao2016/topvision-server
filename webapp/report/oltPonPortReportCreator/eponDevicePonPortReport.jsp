...
function queryClick() {
	queryForm.action = '/epon/report/showEponPonPortReport.tv';
...
function exportExcelClick() {
	...
	window.location.href="/epon/report/exportDevicePonToExcel.tv?entityType=" + entityType+ "&entityIp=" + entityIp+ "&adminState=" + adminState+ "&operationState=" + operationState ; 
}
$(function(){
	new Ext.SplitButton({
			...
			<table class="zebraTableRows" cellpadding="0" cellspacing="0" border="0">
				<tbody>
					<tr>
						...
						<td>
							<select id="entityType" name="entityType" style="width: 120px;" class="normalSel">
						...
						<td>
							<input class="normalInput" name="entityIp" id="entityIp" type=text style="width: 120px;" />
						</td>
					</tr>
					<tr>
		...
		<table class="reportTable" id="reportTable">
			<thead>
				<tr>
					...
					<th class="nowrap">@report.class@</th>
			...
			<tbody>
				<s:iterator value="ponlist">
					<tr>
						...
						<td><s:property value="ponPort" /></td>
						<td class="nowrap"><s:property value="ponPortTypeString" /></td>
						<td class="nowrap"><s:property value="ponPortAdminStatusString" /></td>
						<td class="nowrap"><s:property value="ponOperationStatusString" /></td>
					</tr>
				</s:iterator>
			</tbody>
		</table>

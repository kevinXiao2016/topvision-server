...
function query(){
	...
	location.href = "/cmc/report/showCcmtsUpChlFlowAsset.tv?stTime=" + stTime + "&etTime=" + etTime;	
}
...
function exportExcelClick() {
	...
	var etTime = etField.value;
	var entityType = $("#entityType").val();
	window.location.href="/cmc/report/exportCcmtsUpChlFlowReportToExcel.tv?stTime=" + stTime + "&etTime=" + etTime; 
}
...
function showCcmtsUpChlFlowDetail(entityId, rangeName){
	var stTime = stField.value;
	var etTime = etField.value;
	var url = "/cmc/report/showCcmtsUpChlFlowDetail.tv";
	url += "?stTime= " + stTime + "&etTime=" + etTime + "&rangeName=" + rangeName;
	if(entityId!='null'){
		url += "&entityId=" + entityId;
	}
	window.parent.addView("ccmtsUpChlFlowDetail"+ Math.random(),"@report.ccmtsUpChlFlowDetail@",'reportIcon', url);
}
</script>
</head>
	...
	<div class="report-content-div" id="pageview">
		...
		<table class="reportTable" id="reportTable">
			...
			<tbody>
				...
				Map<String, List<CcmtsChlFlowStatic>> statUpChlFlowStatic = (Map<String, List<CcmtsChlFlowStatic>>) request.getAttribute("statUpChlFlowStatic");
		        ...
		        %>   
		        	<tr>
		        		...
		        		<%if(entity.getUsage90to100()==0){ %>
		        			0
		        		<%}else{ %>
		        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('<%=entity.getEntityId()%>', 'usage90to100')"><%=entity.getUsage90to100()%></a>
		        		<%} %>
		        		</td>
		        		<td>
		        		<%if(entity.getUsage80to90()==0){ %>
		        			0
		        		<%}else{ %>
		        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('<%=entity.getEntityId()%>', 'usage80to90')"><%=entity.getUsage80to90()%></a>
		        		<%} %>
		        		</td>
		        		<td>
		        		<%if(entity.getUsage70to80()==0){ %>
		        			0
		        		<%}else{ %>
		        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('<%=entity.getEntityId()%>', 'usage70to80')"><%=entity.getUsage70to80()%></a>
		        		<%} %>
		        		</td>
		        		<td>
		        		<%if(entity.getUsage60to70()==0){ %>
		        			0
		        		<%}else{ %>
		        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('<%=entity.getEntityId()%>', 'usage60to70')"><%=entity.getUsage60to70()%></a>
		        		<%} %>
		        		</td>
		        		<td>
		        		<%if(entity.getUsage50to60()==0){ %>
		        			0
		        		<%}else{ %>
		        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('<%=entity.getEntityId()%>', 'usage50to60')"><%=entity.getUsage50to60()%></a>
		        		<%} %>
		        		</td>
		        		<td>
		        		<%if(entity.getUsage40to50()==0){ %>
		        			0
		        		<%}else{ %>
		        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('<%=entity.getEntityId()%>', 'usage40to50')"><%=entity.getUsage40to50()%></a>
		        		<%} %>
		        		</td>
		        		<td>
		        		<%if(entity.getUsage30to40()==0){ %>
		        			0
		        		<%}else{ %>
		        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('<%=entity.getEntityId()%>', 'usage30to40')"><%=entity.getUsage30to40()%></a>
		        		<%} %>
		        		</td>
		        		<td>
		        		<%if(entity.getUsage20to30()==0){ %>
		        			0
		        		<%}else{ %>
		        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('<%=entity.getEntityId()%>', 'usage20to30')"><%=entity.getUsage20to30()%></a>
		        		<%} %>
		        		</td>
		        		<td>
		        		<%if(entity.getUsage10to20()==0){ %>
		        			0
		        		<%}else{ %>
		        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('<%=entity.getEntityId()%>', 'usage10to20')"><%=entity.getUsage10to20()%></a>
		        		<%} %>
		        		</td>
		        		<td>
		        		<%if(entity.getUsage0to10()==0){ %>
		        			0
		        		<%}else{ %>
		        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('<%=entity.getEntityId()%>', 'usage0to10')"><%=entity.getUsage0to10()%></a>
		        		<%} %>
		        		</td>
		        		<td>
		        		<%if(entity.getUsage0()==0){ %>
		        			0
		        		<%}else{ %>
		        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('<%=entity.getEntityId()%>', 'usage0')"><%=entity.getUsage0()%></a>
		        		<%} %>
		        		</td>
		        	</tr>
		        <%             
	        	...
	        	<tr>
	        		...
	        		<%if(totalUsage90to100==0){ %>
	        			0
	        		<%}else{ %>
	        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('null', 'usage90to100')"><%=totalUsage90to100%></a>
	        		<%} %>
	        		</td>
	        		<td>
	        		<%if(totalUsage80to90==0){ %>
	        			0
	        		<%}else{ %>
	        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('null', 'usage80to90')"><%=totalUsage80to90%></a>
	        		<%} %>
	        		</td>
	        		<td>
	        		<%if(totalUsage70to80==0){ %>
	        			0
	        		<%}else{ %>
	        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('null', 'usage70to80')"><%=totalUsage70to80%></a>
	        		<%} %>
	        		</td>
	        		<td>
	        		<%if(totalUsage60to70==0){ %>
	        			0
	        		<%}else{ %>
	        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('null', 'usage60to70')"><%=totalUsage60to70%></a>
	        		<%} %>
	        		</td>
	        		<td>
	        		<%if(totalUsage50to60==0){ %>
	        			0
	        		<%}else{ %>
	        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('null', 'usage50to60')"><%=totalUsage50to60%></a>
	        		<%} %>
	        		</td>
	        		<td>
	        		<%if(totalUsage40to50==0){ %>
	        			0
	        		<%}else{ %>
	        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('null', 'usage40to50')"><%=totalUsage40to50%></a>
	        		<%} %>
	        		</td>
	        		<td>
	        		<%if(totalUsage30to40==0){ %>
	        			0
	        		<%}else{ %>
	        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('null', 'usage30to40')"><%=totalUsage30to40%></a>
	        		<%} %>
	        		</td>
	        		<td>
	        		<%if(totalUsage20to30==0){ %>
	        			0
	        		<%}else{ %>
	        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('null', 'usage20to30')"><%=totalUsage20to30%></a>
	        		<%} %>
	        		</td>
	        		<td>
	        		<%if(totalUsage10to20==0){ %>
	        			0
	        		<%}else{ %>
	        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('null', 'usage10to20')"><%=totalUsage10to20%></a>
	        		<%} %>
	        		</td>
	        		<td>
	        		<%if(totalUsage0to10==0){ %>
	        			0
	        		<%}else{ %>
	        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('null', 'usage0to10')"><%=totalUsage0to10%></a>
	        		<%} %>
	        		</td>
	        		<td>
	        		<%if(totalUsage0==0){ %>
	        			0
	        		<%}else{ %>
	        			<a href="javascript:;" onclick="showCcmtsUpChlFlowDetail('null', 'usage0')"><%=totalUsage0%></a>
	        		<%} %>
	        		</td>
	        	</tr>
			</tbody>

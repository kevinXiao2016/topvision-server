...
<table width=100% cellspacing=0 cellpadding=0>
    <tr><td height=30 width=100px><fmt:message key="ALERT.name" bundle="${fault}"/><font color=red>*</font>:</td><td><input class=iptxt name="name" id="name" type=text 
...
<table width=100% cellspacing=0 cellpadding=0>
<tr><td align=right>
<button class=BUTTON75 onMouseOver="this.className='BUTTON_OVER75'" onMouseOut="this.className='BUTTON75'" onclick="lastClick()"><fmt:message key="ALERT.beforeStep" bundle="${fault}"/></button>&nbsp;
<button id=lastBtn class=BUTTON75 onMouseOver="this.className='BUTTON_OVER75'" onMouseOut="this.className='BUTTON75'"><fmt:message key="ALERT.nextStep" bundle="${fault}"/></button>&nbsp;

...
<Zeta:Loader>
    ...
    import performance.js.onuTemplate
</Zeta:Loader>
<style type="text/css">
...
var templateType = EntityType.getOnuType();;
var parentType = EntityType.getOnuType();
		...
		<div id="searchDiv">
			<table>
				<tr>
					...
					<td>@resources/COMMON.uplinkDevice@:</td>
					...
					<td><select id="tempRela" class="normalSel" style="width:80px;">
						<option value="0">@resources/COMMON.pleaseSelect@</option>

...
function cancel(){
	...
	window.parent.closeWindow("batchModifyGroupOltPerf");
}
...
function save(){
	...
	$.ajax({
		url: '/epon/perfTarget/batchModifyOltGroupPerfTarget.tv',
    	type: 'POST',
...
<body class="openWinBody">
	...
	<div class="openWinHeader">
		<div class="openWinTip">@Tip.oltBatchGroupTitle@</div>
     	...
     	<table class="zebraTableRows" cellpadding="0" cellspacing="0" border="0">
            <tbody>
                ...
                <tr class="darkZebraTr">
                    ...
                    <td>
                 	    <input id="collectCycle" class="normalInput" type="text" maxlength="4" toolTip="@Tip.collectTimeRule@" />

...
function cancel(){
	parent.getFrame("cmtsPerfParamConfig").onRefreshClick();
	window.parent.closeWindow("batchModifyGroupCmtsPerf");
}
...
function save(){
	...
	$.ajax({
		url: '/cmts/perfTarget/batchModifyCmtsGroupPerfTarget.tv',
    	type: 'POST',
...
$(document).ready(function() {
	/* menu = new Ext.menu.Menu({
   	    items: [{text: "@Performance.service@", id:'service' ,handler: selectPerf},
   	         	{text: "@Performance.flow@", id:'flow' ,handler: selectPerf},
   	        	{text: "@Performance.signalQuality@", id:'signalQuality' ,handler: selectPerf}
   	    ]
	});
	
	new Ext.SplitButton({
		renderTo: 'button-ct',
     	text: '@Tip.selectPerfTargetGroup@',
     	menu: menu
	}) */
...
<body class="openWinBody">
	...
	<div class="openWinHeader">
		<div class="winTip">@Tip.cmtsBatchGroupTitle@</div>
	...
	<div class="edgeTB10LR20 pT40">
		<table class="zebraTableRows" cellpadding="0" cellspacing="0" border="0">
			<tbody>
				<tr>
					<td class="rightBlueTxt" width="200">@Performance.perftarget@:</td>
					<td>

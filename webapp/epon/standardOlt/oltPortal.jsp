...
function switchHandler(){
    window.parent.showConfirmDlg(I18N.EPON.tip, I18N.EPON.switchMaster, function(type) {
        if (type == 'no') {return;}
        ...
        $.ajax({
            ...
            success: function(json) {
                if (json.message) {
                    window.parent.showMessageDlg(I18N.EPON.tip, json.message);
                } else {
                    window.parent.showMessageDlg(I18N.EPON.tip, I18N.EPON.switchOk);
                }
            }, error: function() {
                window.parent.showMessageDlg(I18N.EPON.tip, I18N.EPON.switchError);
...
Ext.onReady(function(){
	...
	if(entityVersion.startWith("1.7.0") || VC.support("mpuaBDRestore")){
		$("#masterSwitch").show();
	}
	//基本信息;
	var portletDetail = {
...
<body  class="newBody clear-x-panel-body">
				...
				<table class="dataTable zebra" width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#DFDFDF" rules="all">
					...
					<tr>
						<td colspan="2" class="txtRight">
							<a class="mR10" href="/epon/standardOlt/showStandardOltConfig.tv?module=2&entityId=<s:property value="entity.entityId"/>">@ENTITYSNAP.basicInfo.more@>></a>
						</td>
					</tr>
				</table>
			</div>
	...
	<div id=tools>
		<dl class="btnGroupDl pB10">
			<dd>
				<a href="javascript:;" class="normalBtnBig" onclick="onDiscoveryAgainClick(entityId, entityIp);"><span><i class="miniIcoRefresh"></i>@network/NETWORK.reTopo@</span></a>
			</dd>
			<%-- <dd>
			...
			<dd>
				<a href="javascript:;" class="normalBtnBig" onclick="setDolPolling()"><span><i class="miniIcoManager"></i>@ENTITYSNAP.tools.dol@</span></a>
			</dd>		
			<% } %>	 --%>
		</dl>		
	</div>

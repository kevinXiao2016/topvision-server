function showCC8800AService(e){ 
    ...
    //items[items.length] = {id:'renameCmc', text: "@RESOURCES/COMMON.realias@",  handler: renameEntity };
...
function showOnuService(e){
    ...
    items[items.length] = {id:'refrheshOnu', text: "@COMMON.refresh@",  handler: refreshOnu};
    items[items.length] = {id:'renameCmc', text: "@RESOURCES/COMMON.realias@",  handler: renameEntity };

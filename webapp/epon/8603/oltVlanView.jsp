...
<body class="newBody overfloatHidden bodyWH100percent" onload="authLoad()">
	<div class="wrapWH100percent overfloatHidden">
		...
		<div id="viewMiddle" class="viewMiddle">
			...
			<!-- <ul class="whiteTabUl abAndBL10" id="imgTextMode">
				<li><a id="imgMode" href="javascript:;" class="first selectedFirst" ><span>@VLAN.imgMode@</span></a></li>
				<li><a id="textMode" href="javascript:;" class="last" ><span>@VLAN.textMode@</span></a></li>
			</ul> -->

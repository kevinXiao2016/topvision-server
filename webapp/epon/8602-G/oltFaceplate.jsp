        ...
        if(slotType == "fan"){
            ...
            if (portIndex == 0) {//board
               if (UPLINK_BOARD.contains(slotType) || CONTROL_BOARD.contains(slotType)) {//GE
                ...
                if (portIndex > 16 && (slotType == "mgua" || slotType == "mgub" || slotType == "mgfa" || slotType == "mgfb") ) {//SNI口
                	var sniPort = null;
...
function beginConstructTree(){
	try {
		var root = new Ext.tree.TreeNode({text : "PN8602-G",id : "OLT",expanded : true,icon : '/epon/image/pn8602-ef/8602EF-16.png'});
		var slotName = null;
					...
					<div id="NotationsContainer">
						<div class="edge5 DeviceNotation">
							<table class="dataTable zebra noWrap" width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#DFDFDF" rules="all">
								<tbody>
								    <tr>
								        <td class="rightBlueTxt">MGUA/MGUB/MGFA/MGFB:</td>
								        <td>@EPON.geua@</td>
								        <td class="rightBlueTxt">MGUA/MGUB/MGFA/MGFB:</td>
								        <td>@EPON.mpua@</td>
										<td class="rightBlueTxt">MGUA/MGUB/MGFA/MGFB:</td>

...
<script type="text/javascript">
    ...
    function exportFile(){
    	exportExcel(grid,'@network/NETWORK.ponPortSpeed@');
    }
    ...
    $(function() {
        ...
        store = new Ext.data.JsonStore({
            url : '/epon/perf/loadPonSpeedList.tv',
            root : 'data',
            totalProperty : 'rowCount',
            remoteSort : true,
            fields : [ 'entityId','ip', 'name',{"name":"portIndex","mapping":'portName'},
                       {"name":"portInSpeed","mapping":'inSpeed'},

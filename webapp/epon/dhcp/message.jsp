...
<script type="text/javascript">
    ...
    function initData(callback){
    	var data = [];
    	$.ajax({
			url : '/epon/oltdhcp/loadltDhcpStatistics.tv',
			type : 'POST',
			data : {
				entityId : entityId
			},
    ...
    function adjustmentData(json){
    	var data = [{
        	title: 'DHCP DISCOVER<br />@oltdhcp.statistics.messages@',
        	receive: json.topOltDhcpStatRDiscover,
        	send: json.topOltDhcpStatTDiscover,
        	discard: json.topOltDhcpStatDDiscover
        },{
        	title: 'DHCP REQUEST<br />@oltdhcp.statistics.messages@',
        	receive: json.topOltDhcpStatRRequest,
        	send: json.topOltDhcpStatTRequest,
        	discard: json.topOltDhcpStatDRequest
        },{
        	title: 'DHCP OFFER<br />@oltdhcp.statistics.messages@',
        	receive: json.topOltDhcpStatROffer,
        	send: json.topOltDhcpStatTOffer,
        	discard: json.topOltDhcpStatDOffer
        },{
        	title: 'DHCP ACK<br />@oltdhcp.statistics.messages@',
        	receive: json.topOltDhcpStatRAck,
        	send: json.topOltDhcpStatTAck,
        	discard: json.topOltDhcpStatDAck
        },{
        	title: 'DHCP <br />@oltdhcp.statistics.other@@oltdhcp.statistics.messages@',
        	receive: json.topOltDhcpStatROther,
        	send: json.topOltDhcpStatTOther,
        	discard: json.topOltDhcpStatDOther
        },{
        	title: 'DHCP FLood<br />@oltdhcp.statistics.messages@',
        	discard: json.topOltDhcpStatDFlood
        },{
        	title: 'DHCP Unknown<br />@oltdhcp.statistics.messages@',
        	discard: json.topOltDhcpStatDUnknown
        },{
        	title: 'DHCP Congestion<br />@oltdhcp.statistics.messages@',
        	discard: json.topOltDhcpStatDCongestion
        }];
    	return data;
    }
    ...
    function refreshBtn(){
	    ...
	    $.ajax({
	        url:"/epon/oltdhcp/refreshOltDhcpStatistics.tv",
	        method:"post",
	        data : {
				entityId : entityId
			},
    ...
    function clearBtn(){
	    ...
	    $.ajax({
	        url:"/epon/oltdhcp/clearOltDhcpStatistics.tv",
	        method:"post",
	        data : {
				entityId : entityId
			},
    ...
    <body class="grayBg edge10 pT0" onload="authLoad()">
    	...
    	<ol class="upChannelListOl pB0 pT20 noWidthCenter clearBoth">
		    ...
		    <li><a id="clearBtn" href="javascript:;" onclick="clearBtn()" class="normalBtnBig"><span><i class="miniIcoForbid"></i>清除统计信息</span></a></li>
		</ol>
    </body>
</Zeta:HTML>
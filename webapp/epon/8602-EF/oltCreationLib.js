...
function getLeft(j){
	...
	if(j < 5) {
		...
		//GE
		return Math.floor(j-19) * 21 + geStart;
	}
}
 ...
 * @param json
 */
function createPN8602EF() {
	var $pretype = olt.slotList[0].topSysBdPreConfigType;
	if($pretype==19) {
		image_device = "/epon/image/pn8602-ef/pn8602_MEFA.png";
		olt.type = 'mefa';
	} else if($pretype == 20) {
		image_device = "/epon/image/pn8602-ef/pn8602_MEFB.png";
		olt.type = 'mefb';
	} else if($pretype == 21) {
		image_device = "/epon/image/pn8602-ef/pn8602_MEFC.png";
		olt.type = 'mefc';
	}else if($pretype == 22) {
			image_device = "/epon/image/pn8602-ef/pn8602_MEFB.png";
			olt.type = 'mefd';

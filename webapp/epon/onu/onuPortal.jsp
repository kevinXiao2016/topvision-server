...
$(function(){
	...
	if(ONU_MTK_TYPE.contains(typeId)){
		R.isolated.hide();
		R.rstpCfg.hide();
	}
	
});
function onuTempretureEnableHandler() {
	tempretureEnableHandler(function() {
		location.reload();
    });
}
function onuIsolatedEnableHandler() {
	isolatedEnableHandler(function() {
        location.reload();
    });
}
function onuStasitcEnableHandler() {
...
Ext.onReady(function(){
	$("#gePortList").text(${oltOnuCapability.onuGePortList}.join(","));
	$("#fePortList").text(${oltOnuCapability.onuFePortList}.join(",") || "-" );
	$("#fecEnable").text(${oltOnuCapability.onuFecEnable} == 1 ? "@STATUS.up@":"@STATUS.down@")
	...
	if( !leftPartStr || !rightPartStr){
		...
		if(catvCapability == 1){
			rightPartStr = "portletTools,portletSysUpTime,ponOpticalInfo,onuCatvInfo";
		}else{
		    rightPartStr = "portletTools,portletSysUpTime,ponOpticalInfo";
		}
	}
    ...
    if(onuStatus == 1){
    	...
    	$("#onuWorkingVoltage").html('${onuPonAttribute.onuWorkingVoltage}' == 0? "--" : ('${onuPonAttribute.onuWorkingVoltage}' / 100).toFixed(2) +'  mV');
	...
	$("#onuChipVendor").text(convert2Bit(${onuAttribute.onuChipVendor }) );
...
<body  class="newBody clear-x-panel-body" onload="authLoad()">
		...
		<div id="detail">
			<div style="position:relative">
				...
				<table class="dataTable zebra" width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#DFDFDF" rules="all">
					<tr>
						<td width=100 class="rightBlueTxt">@COMMON.alias@@COMMON.maohao@</td>					
					...
					<tr>
						...
						<td class="txtLeftEdge wordBreak"><div class="pR230">${onuAttribute.onuMac }</div></td>
					</tr>

					<tr>
						<td class="rightBlueTxt">@ONU.upLinkName@@COMMON.maohao@</td>
						<td class="txtLeftEdge wordBreak" ><div class="pR230">${olt.name }</div></td>
					</tr>
					<tr>
						<td class="rightBlueTxt">@ONU.uplinkType@@COMMON.maohao@</td>
						<td class="txtLeftEdge wordBreak" ><div class="pR230">${olt.typeName }</div></td>
					</tr>
					<tr>
						<td class="rightBlueTxt">@ONU.uplinkIp@@COMMON.maohao@</td>
						<td class="txtLeftEdge wordBreak" ><div class="pR230">${olt.ip }</div></td>
					</tr>
					<tr>
						<td class="rightBlueTxt">@downlink.prop.mgmtstatus@@COMMON.maohao@</td>
						<td class="txtLeftEdge wordBreak" ><div class="pR230" id="onuAdminStatus"></div></td>
					</tr>
					<tr>
						<td class="rightBlueTxt">@ONU.chipvender@@COMMON.maohao@</td>
						<td class="txtLeftEdge wordBreak" ><div id="onuChipVendor" class="pR230"></div></td>
					</tr>
					<tr>
						<td class="rightBlueTxt">@downlink.prop.chipType@@COMMON.maohao@</td>
						<td id="onuChipType" class="txtLeftEdge wordBreak" ></td>
					</tr>
					<tr>
						<td class="rightBlueTxt">@downlink.prop.testDistance@@COMMON.maohao@</td>
						<td class="txtLeftEdge wordBreak" >${onuAttribute.onuTestDistance } m</td>
					</tr>
					<tr>
						<td class="rightBlueTxt">LLID@COMMON.maohao@</td>
						<td id="LLID" class="txtLeftEdge wordBreak" ></td>
					</tr>
					<tr>
						<td class="rightBlueTxt">@ONU.softVersion@@COMMON.maohao@</td>
						<td class="txtLeftEdge wordBreak"  id="putSoftVersion">${onuAttribute.onuSoftwareVersion }</td>
					</tr>
					<tr>
						<td class="rightBlueTxt">@epon/EPON.hardwareVersion@@COMMON.maohao@</td>
						<td class="txtLeftEdge wordBreak" id="putTopOnuHardwareVersion">${onuAttribute.topOnuHardwareVersion }</td>
					</tr>
					<tr id="wifiSoftVersion">
						<td class="rightBlueTxt">WIFI @ONU.softVersion@@COMMON.maohao@</td>
						<td class="txtLeftEdge wordBreak">${onuWanConfig.softVersion}</td>
					</tr>
					<tr id="wifiHardVersion">
						<td class="rightBlueTxt">WIFI @epon/EPON.hardwareVersion@@COMMON.maohao@</td>
						<td class="txtLeftEdge wordBreak">${onuWanConfig.hardVersion}</td>
					</tr>
					<tr>
                        <td class="rightBlueTxt">@ENTITYSNAP.basicInfo.contact@@COMMON.maohao@</td>                   
                        <td class="txtLeftEdge wordBreak"><div class="pR120">${onu.contact}</div></td>
                    </tr>
                    <tr>
                        <td class="rightBlueTxt">@ENTITYSNAP.basicInfo.location@@COMMON.maohao@</td>                  
                        <td class="txtLeftEdge wordBreak"><div class="pR120">${onu.location}</div></td>
                    </tr>
                    <tr>
                        <td class="rightBlueTxt">@ENTITYSNAP.basicInfo.note@@COMMON.maohao@</td>                  
	...
	<div id="tools">
		<dl class="btnGroupDl pB10">
			...
			<Zeta:Button  id='onuOptical' ignoreLi="true" icon="miniIcoRefresh" onclick="onuOpticalAlarmHandler()" checkOperatePower="true">@EPON.optThrMgmt@</Zeta:Button>
			...
			<Zeta:Button  id="isolated" ignoreLi="true" icon="miniIcoRefresh" onclick="onuIsolatedEnableHandler()" checkOperatePower="true">@downlink.menu.isolatedEnable@</Zeta:Button>
			<Zeta:Button  ignoreLi="true" icon="miniIcoRefresh" onclick="onuTempretureEnableHandler()" checkOperatePower="true">@downlink.menu.tempretureEnable@</Zeta:Button>
			<Zeta:Button  id="rstpCfg" ignoreLi="true" icon="miniIcoRefresh" onclick="rstpCfgHandler()" checkOperatePower="true">@ONU.RSTPCfg@</Zeta:Button>
			...
			<Zeta:Button  ignoreLi="true" icon="miniIcoRefresh" onclick="onuIgmpConfigView()" checkOperatePower="true">@COMMON.igmpConfig@</Zeta:Button>
			<Zeta:Button  ignoreLi="true" icon="miniIcoRefresh" onclick="onuStasitcEnableHandler()" checkOperatePower="true">@ONU.ponPerfStastic@</Zeta:Button>
    ...
    <div id="subInfo" style="dislpay: none">
    	<table class="dataTable zebra noWrap" width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#DFDFDF" rules="all">
            <tr>
                <td class="rightBlueTxt" width="100">@ONU.portCountGE@@COMMON.maohao@</td>
                <td id="onuTotal">${oltOnuCapability.onuGePortNum }</td>
                <td class="rightBlueTxt" width="100">@ONU.portCountFE@@COMMON.maohao@</td>
                <td>${oltOnuCapability.onuFePortNum}</td>
            </tr>
            <tr>
                <td class="rightBlueTxt" width="100">@ONU.portNumGE@@COMMON.maohao@</td>
                <td id="gePortList"></td>
                <td class="rightBlueTxt" width="100">@ONU.portNumFE@@COMMON.maohao@</td>
                <td id="fePortList"></td>
            </tr>
            <tr>
                <td class="rightBlueTxt" width="100">@ONU.upstreamQueue@@COMMON.maohao@</td>
                <td>${oltOnuCapability.onuQueueNumUplink }</td>
                <td class="rightBlueTxt" width="100">@ONU.downstreamQueue@@COMMON.maohao@</td>
                <td>${oltOnuCapability.onuQueueNumDownlink }</td>
            </tr>
            <tr>
                <td class="rightBlueTxt" width="100">@ONU.upstreamMaxQueue@@COMMON.maohao@</td>
                <td>${oltOnuCapability.onuMaxQueueNumUplink }</td>
                <td class="rightBlueTxt" width="100">@ONU.downstreamMaxQueue@@COMMON.maohao@</td>
                <td>${oltOnuCapability.onuMaxQueueNumDownlink }</td>
            </tr>
            <tr>
                <td class="rightBlueTxt" width="100">@downlink.menu.FECEnable@@COMMON.maohao@</td>
                <td id="fecEnable"></td>
                <td class="rightBlueTxt" width="100"></td>
                <td></td>
            </tr>
        </table>
    </div>
    ...
    <div id="opticalInfo" style="dislpay: none">
    	<table class="dataTable zebra noWrap" width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#DFDFDF" rules="all">
            <tr>
                <td class="rightBlueTxt" width="100">@Optical.biasCurrent@@COMMON.maohao@</td>
                <td id="onuBiasCurrent"></td>
                <td class="rightBlueTxt" width="100">@downlink.prop.voltage@@COMMON.maohao@</td>
                <td id="onuWorkingVoltage"></td>
            </tr>
            <tr>
                <td class="rightBlueTxt" width="100">@ONU.tempretureOpt@@COMMON.maohao@</td>
                <td id="tempreture"></td>
                <td class="rightBlueTxt" width="100">@ONU.recOptRate@@COMMON.maohao@</td>
                <td id="receivedOpticalPower"></td>
            </tr>
            <tr>
                <td class="rightBlueTxt" width="100">@ONU.sendOptRate@@COMMON.maohao@</td>
                <td id="onuTramsmittedOpticalPower"></td>
                <td class="rightBlueTxt" width="100">@ONU.ponOpticalRecv@@COMMON.maohao@</td>

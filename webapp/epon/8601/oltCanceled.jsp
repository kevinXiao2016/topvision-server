		...
		<table cellspacing=5>
			<tr>
				...
				<tr>
					...
					<td width=10></td>
					<td colspan=2><fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.zaiwei" /><s:property value="slotNumInUse"/><fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.ge" />,
					<fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.gong" /><s:property value="oltAttribute.oltDeviceNumOfTotalServiceSlot"/><fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.ge" /></td>
				</tr>
				<tr>
					<td width=80 align="right"><fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.powers" />:</td>
					<td width=10></td>
					<td colspan=2><fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.zaiwei" /><s:property value="powerNumInUse"/><fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.ge" />,
					<fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.gong" /><s:property value="oltAttribute.oltDeviceNumOfTotalPowerSlot"/><fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.ge" /></td>
				</tr>
				<tr>
					<td width=80 align="right"><fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.fans" />:</td>
					<td width=10></td>
					<td colspan=2><fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.zaiwei" /><s:property value="fanNumInUse"/><fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.ge" />,
					<fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.gong" /><s:property value="oltAttribute.oltDeviceNumOfTotalFanSlot"/><fmt:message bundle="${cancel}" key="ENTITYSNAP.basicInfo.ge" /></td>
				</tr>
				<tr>

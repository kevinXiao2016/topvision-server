...
function saveClick() {
	 ...
	 if(inCheck == 1){
		...
		if(!checkInput(inCBS)||inCBS > 16777215  || inCBS < 0){
			return Zeta$("inCBS").focus();
		}
		if(!checkInput(inEBS)||inEBS > 16777215 || inEBS < 0){
	             ...
	             <tr class="darkZebraTr">
	                 ...
	                 <td>
						<input type=text id="inCBS" class="normalInput"
								...
								size=10 maxlength=8  tooltip="@SERVICE.uniPortInCBSTip1@" /> Bytes
	                 </td>
	             </tr>
	             <tr>
	                 ...
	                 <td>
						<input type=text id="inEBS" class="normalInput"
								...
								size=10 maxlength=8  tooltip="@SERVICE.uniPortInEBSTip1@" /> Bytes
	                 </td>
	                  <td class="rightBlueTxt">

...
<script type="text/javascript">
	...
	var pppoEPlusEnable = parseInt('${pppoEPlusEnable}',10); //开关的状态, 1表示开，0表示关;
...
<body class="whiteToBlack" onload="authLoud()">
	<div id="topPart">
		<ul class="leftFloatUl edge10">
			<li class="rightBlueTxt pT5">@oltdhcp.pppoeSwitch@@COMMON.maohao@</li>
			<li id="putSwitch" class="pT3 pR10"></li>
			<li>
				<a id="refreshBtn" href="javascript:;" onclick="refresh()" class="normalBtn"><span><i class="miniIcoEquipment"></i>@oltdhcp.refreshPPPoEData@</span></a>
			</li>
		</ul>

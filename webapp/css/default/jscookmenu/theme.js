...
var cmThemeIEBase = 'css/default/jscookmenu/';
...
var cmTheme =
{
	...
	// HTML code to the left of the folder item
	folderLeft: '<img alt="" src="' + cmThemeIEBase + 'spacer.gif">',
	// HTML code to the right of the folder item
	folderRight: '<img alt="" src="' + cmThemeIEBase + 'arrow.gif" align="top">&nbsp;',
	// HTML code to the left of the regular item
	itemLeft: '<img alt="" src="' + cmThemeIEBase + 'spacer.gif">',
	// HTML code to the right of the regular item
	itemRight: '',
...
/*@cc_on
	cmTheme.subMenuHeader = '<div class="ThemeIESubMenuShadow" style="background-color: #7f7f7f;filter: alpha(opacity=50);"></div><div class="ThemeIESubMenuBorder">';
@*/

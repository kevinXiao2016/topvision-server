...
if (Ext.MessageBox) {
	Ext.MessageBox.buttonText = {
		ok : "<span class='miniIcoSaveOK' style='padding-left:16px;'>OK</span>",
		cancel : "<span class='miniIcoForbid' style='padding-left:16px;'>Close</span>",
		yes : "<span class='miniIcoSaveOK' style='padding-left:16px;'>Yes</span>",
		no : "<span class='miniIcoWrong' style='padding-left:16px;'>No</span>"
	}
}
if (Ext.util.Format) {
...
Extux.TabCloseMenu = {
	...
	closeOtherTabText : 'Close other tabs',
	closeAllTabText : 'Close all tabs',
	confirmText : 'Confirm',
	closeAllMsg : 'Close all tabs really?',
	closeOtherMsg : 'Close other tabs really?'
};

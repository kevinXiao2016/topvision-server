 ...
 *	ui.core.js
 *
 * Modified by autohor: niejun
 * for support the vml line in topology map, enhance speed.
 */
(function($) {
...
$.widget("ui.selectable", $.extend($.ui.mouse, {
	init: function() {
		...
		this.refresh = function() {
			...
			selectees.each(function() {
				// VML/BR/SPAN return, modified by niejun
				...
				if(!(tagName == 'DIV' || tagName == 'div')) {
					switch (tagName) {
						...
						case 'RoundRect':
						case 'Oval':
							this.strokecolor = (this.oldColor ? this.oldColor : linkStyle.color);
							break;
						case 'TextBox':
	...
	// enhance selection area, modified by niejun
	...
	mouseStart: function(e) {
		...
		// enhance scroll speed, modified by niejun
		if (e.pageX >= this.element[0].clientWidth || e.pageY >= (this.element[0].clientHeight+25) || e.pageY < 30)
			return;

var removeTitle=I18N.DOCUMENT.remove;
var errorTitle=I18N.DOCUMENT.error;
var finishTitle=I18N.DOCUMENT.finish;
var uploadTitle=I18N.DOCUMENT.upload;
var cancelTitle=I18N.DOCUMENT.cancel;
var browseTitle='...'+I18N.DOCUMENT.browse;
var emptyTitle=I18N.DOCUMENT.empty;
...
dhtmlXVaultObject.prototype.create = function(htmlObject)
{
	...
	this.containerDiv.className = 'fileContainer';
    this.containerDiv.style.cssText = "position:absolute;overflow-y:auto;height:280px;top:0px;left:0px;z-index:10;width:100%";
    ...
    var str = "<table cellspacing=0 cellpadding=0 border='0'>" +
              "<tr><td style='width:300px' colspan=3 align='center' id = 'cellContainer' >" +
              "<div style='height:290px;'></div>" +
              "</td></tr>" +
              "<tr><td style=';width: 80px; height: 32px;' align='left'></td>" +
              "<td align='right' style='width: 240px; height: 32px;'>" +
			  "<button id=okBt class=BUTTON75 onMouseOver=\"this.className='BUTTON_OVER75'\" onMouseOut=\"this.className='BUTTON75'\">"+emptyTitle+"</button>&nbsp;<button id=okBt class=BUTTON75 onMouseOver=\"this.className='BUTTON_OVER75'\" onMouseOut=\"this.className='BUTTON75'\">"+uploadTitle+"</button>&nbsp;</td>"+
              //"<img _onclick='UploadControl.prototype.uploadAllItems()' _ID='ImageButton3'  src='../include/imgs/btn_upload.gif' style='cursor:pointer'/></td>" +
              "<td style='height: 32px;' align='right'>" +
			  "<button id=cancelBt class=BUTTON75 onMouseOver=\"this.className='BUTTON_OVER75'\" onMouseOut=\"this.className='BUTTON75'\" onclick=\"cancelClick()\">"+cancelTitle+"</button></td></tr></table>"+
              //"<img _onclick='return UploadControl.prototype.removeAllItems()' _ID='ImageButton3'  src='../include/imgs/btn_clean.gif' style='cursor:pointer;margin-right:20px'/></td></tr></table>" +

              "<div _id='fileContainer' style='width:75px;overflow:hidden;height:22px;left:79px;direction:rtl;position:absolute;top:295px'>" +
              //"<img style='z-index:2' src='../include/imgs/btn_add.gif'/>" +
			  "<button id=browseBt class=BUTTON75 onMouseOver=\"this.className='BUTTON_OVER75'\" onMouseOut=\"this.className='BUTTON75'\">"+browseTitle+"</button>"+
              "<input type='file' id='file1' hidefocus name='file1' value='' class='hidden' style='z-index:3;filter:alpha(opacity=0);position:absolute;width:30px;height:22px;left:5px;top:0px'/></div>";
    ...
    this.container.childNodes[0].rows[1].cells[1].childNodes[2].onclick = function() {
		self.uploadAllItems();
    };
...
dhtmlXVaultObject.prototype.addFile = function()
{
	...
	tblContent.className = 'fileRecord';
    ...
    cellList.innerHTML = "<div style='overflow: hidden;width:280px;'><div class='fileName' style='width:280px;'>" + fileName + "</div></div> ";
    ...
    cellList.innerHTML = "<a href='#remove' class='link'>"+removeTitle+"</a>";
    ...
    cellList = document.createElement("td");
    cellList.style.cssText = ";width:140px;height:30px;";
    cellList.innerHTML = "<a href='#upload' class='link'></a>";
    cellList.firstChild.onclick = function() {
...
{
    //-------------------------------------------
    var srcImgPic = "../include/imgs/ico_image.png";
    var srcImgVideo = "../include/imgs/ico_video.png";
    var srcImgSound = "../include/imgs/ico_sound.png";
    var srcImgArchives = "../include/imgs/ico_zip.png";
    var srcImgFile = "../include/imgs/ico_file.png";
...
{
    var srcImgProgress = "../include/imgs/pb_demoUload.gif";
...
try{
    var xmlHttp = this.createXMLHttpRequest();
            ...
            if (xmlHttp.responseText)
            {
                     ...
                     if (parseInt(xmlHttp.responseText) != -1)
                        ...
                        } else if (parseInt(xmlHttp.responseText) == -1)
                        {
                            ...
                            tblContent.rows[1].cells[0].innerHTML += "<font class='text' >"+finishTitle+"</font>";
     ...
     catch(e)
     {
          ...
          this.isUploadFileAll = "false";
          var tblContent = this.getCurrentTblContent(id);
          tblContent.rows[1].cells[0].innerHTML += "<font class='text' >"+errorTitle+"</font>";
          tblContent.rows[1].cells[0].vAlign = "top";

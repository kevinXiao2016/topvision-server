...
<script type="text/javascript"> 
    ...
    function exportFile(){
    	exportExcel(grid,'@network/NETWORK.entityDelay@');
    }
    ...
    $(function(){
        	...
        	columns: [
   	          {
   	              ...
   	              header : "@resources/WorkBench.delaying@(ms)",
   	              dataIndex : 'delay',
   	              sortable : true,
   	              align:'center'
   	          }, {
        ...
        store = new Ext.data.JsonStore({
            url : '/portal/loadDeviceDelayList.tv',
            root : 'data',
            totalProperty : 'total',
            remoteSort : false,
            fields : [ 'entityId','parentId','name','parentId','typeName','mac','ip','delay',
                       {"name":"snapTime","mapping":'dtStr'},'delayUpdateTime']
        });

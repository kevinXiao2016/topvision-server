...
.topoSecondPart{ width:100%; height:30px; overflow: hidden; background:#f4f4f4; border-bottom:1px solid #EDEFEE; position:relative; top:0; left:0;}
#wrap{ width:100%; height:100%; overflow:auto; position:relative; /* background:#F7F9F8 url(../images/boxBg.jpg) repeat fixed; */}
#icoWrap{ width:2000px; height:2000px; position:absolute; top:0; left:0; z-index:2;-moz-user-select:none; overflow:hidden;
-webkit-transform-origin: 0 0;
-moz-transform-origin: 0 0;
-ms-transform-origin: 0 0;
transform-origin: 0 0;
}
.nm3kTip{ cursor:pointer;}
.scale_l{-webkit-transform: scale(1); -moz-transform:scale(1); -mx-transform:scale(1); transform:scale(1);}
.scale_m{-webkit-transform: scale(0.8); -moz-transform:scale(0.8); -mx-transform:scale(0.8); transform:scale(0.8);
...
.scale_s{-webkit-transform: scale(0.5); -moz-transform:scale(0.5); -mx-transform:scale(0.5); transform:scale(0.5);}

#icoWrap svg{-webkit-transform-origin: 0 0;}
#putFlash{ position:absolute; top:0; left:0; z-index:1;-moz-user-select:none; overflow:hidden;}

.eqContainer{ width:90px; height:80px; overflow:hidden; background:transparent; position:absolute; text-align:center; border:3px solid transparent;}
.eqContainer img{ margin-top:5px; -moz-user-select:none;}
.eqContainer img.nm3kTopoAlert{ margin:0;}
.eqContainer span{ display:block; width:90px;}
.eqContainerSelected{ border:3px solid #365999;}

.nm3kTopoPercent{ position:absolute; top:0px; right:0px; line-height:1em; z-index:2; padding:3px; -moz-border-radius: 10px;-khtml-border-radius: 10px;-webkit-border-radius: 10px;border-radius: 10px; 
 border-bottom-left-radius:0px; 
}
.nm3kTopoAlert{ position:absolute; top:32px; left:20px; overflow:hidden; width:16px; height:16px; z-index:2;}
.hideAlert .nm3kTopoAlert{ display:none;}
.hidePercent .nm3kTopoPercent{ display:none;}
.nm3kTopoTempDragBox{ overflow:hidden; position:absolute; background:#000; opacity:0.2; z-index:999; filter:alpha(opacity=20);}
#toolTipTxt{ padding:6px 0px 0px 0px; text-align:center;}
#overTip{ width:178px; padding:10px 15px; border:1px solid #767676; background:#FAFBFC; position:absolute; top:35px; left:0px; z-index:1000;
-moz-border-radius: 4px;-khtml-border-radius: 4px;-webkit-border-radius: 4px;border-radius: 4px; display:none;
}
.backLinkBtn{position:absolute; top:4px; left:6px;}
#normalTopPart{ position: absolute; top:0; left:0; width:100%;}
#selectOneIcoPart, #onlySelectOneLine, #selectLines, #selectIcons{ position:absolute; top:0; left:0; width:100%; display:none;}
.topoSearchInput{ width:140px; height:20px; padding-top:2px; border:0px solid transparent; position:absolute; top:3px; right:12px; color:#B9B9B9;}
.topoSearchLinkBtn{ width:16px; height:16px; overflow:hidden; display:block; position:absolute; top:6px; left:6px;}
...
#bubbleTip{ width:322px; border:1px solid #ccc; background:#fff; position:absolute; top:0; left:-400px; z-index:1001; padding:10px 0px;
-moz-border-radius: 6px;-khtml-border-radius: 6px;-webkit-border-radius: 6px;border-radius: 6px; display:none;
-webkit-box-shadow:0px 2px 5px #999;-moz-box-shadow:0px 2px 5px #999;}
#bubbleTip table{ width:100%;}
#bubbleTip td{ white-space:normal; word-break:break-all; word-wrap:break-word;}
.theName{ width:100%;  white-space:normal; word-break:break-all; word-wrap:break-word;}

.zoomBtn{ position: absolute; top:80px; right:26px; border:1px solid #555; background:#fff; padding:6px; cursor:pointer; z-index:999;}
.zoomInBtn{ width:20px; height:16px; overflow:hidden; position: absolute; top:5px; left:0px;}
.zoomOutBtn{ width:20px; height:16px; overflow:hidden; position: absolute; top:87px; left:0px;}
</style>
...
<body>
	<div id="topPart" class="topoTopPart">
		<div id="normalTopPart" class="topBarSelected">
			<div class="noWidthCenterOuter clearBoth">
			     <ol class="upChannelListOl pB0 pT4 noWidthCenter">
			         <li>
			         	<a id="saveLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.save@"><span><i class="miniIcoSave"></i></span></a>
			         </li>
			         <li>
			         	<a onclick="refreshFn()" href="javascript:;" class="normalBtnIco" name="@topo.refresh@"><span><i class="miniIcoRefresh"></i></span></a>
			         </li>
			         <li>
			         	<a id="topoProLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.property@"><span><i class="miniIcoEarth"></i></span></a>
			         </li>
			         <li>
			         	<a id="legentLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.legend@"><span><i class="miniIcoUpdate"></i></span></a>
			         </li>
			         <li>
			         	<a id="pasteLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.paste@"><span><i class="miniIcoCopy"></i></span></a>
			         </li>
			         <li><span class="topoBarLine"></span></li>
			         <li>
			         	<a id="sDrag" href="javascript:;" class="normalBtnIco normalBtnIcoSelect" alt="@topo.dragAlt@" name="@topo.drag@"><span><i class="miniIcoMove"></i></span></a>
			         </li>
			         <li>
			         	<a id="sDrawLine" href="javascript:;" class="normalBtnIco" alt="@topo.drawLineAlt@" name="@topo.drawLine@"><span><i class="miniIcoDrawLine"></i></span></a>
			         </li>
			         <li>
			         	<a id="sDrawRect" href="javascript:;" class="normalBtnIco" alt="@topo.dragBoxAlt@" name="@topo.dragBox@"><span><i class="miniIcoBox"></i></span></a>
			         </li>
			         <li><span class="topoBarLine"></span></li>
			         <li>
			         	<a id="arrangeLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.arrangement@"><span><i class="miniIcoArrangeWithSub"  style="width:28px;"></i></span></a>
			         </li>
			         <li><span class="topoBarLine"></span></li>
			         <li>
			         	<a id="showListLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.view@"><span><i class="miniIcoView"></i></span></a>
			         </li>
			         <li><span class="topoBarLine"></span></li>
			         <li>
			         	<a id="showTipTxt" href="javascript:;" class="normalBtnIco" name="@topo.text@"><span><i class="miniIcoTxt"></i></span></a>
			         </li>
			         <li><span class="topoBarLine"></span></li>
			         <li>
			         	<a id="subDeviceConfig" href="javascript:;" class="normalBtnIco" name="@topo.subDevice@"><span><i></i></span></a>
			         </li>
			     </ol>
			</div>
			<div class="topoSelectInput">
				<a href="javascript:;" class="topoSearchLinkBtn" id="topoSearchLinkBtn"></a>
				<input type="text" id="topoSearchInput" class="topoSearchInput" value="@topo.find@" />
			</div>
		</div>
		<div id="selectOneIcoPart">
			<div class="noWidthCenterOuter clearBoth">
			     <ol class="upChannelListOl pB0 pT4 noWidthCenter">
			         <li>
			         	<a id="fixedBtn" href="javascript:;" class="normalBtnIco" name="@topo.fixed@"><span><i class="miniIcoLock"></i></span></a>
			         </li>
			         <li><span class="topoBarLine"></span></li>
			         <li id="cutLi">
			         	<a id="cutOneLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.cut@"><span><i class="miniIcoPageBorder"></i></span></a>
			         </li>
			         <li id="copyLi">
			         	<a id="copyOneLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.copy@"><span><i class="miniIcoCopy"></i></span></a>
			         </li>
			         <li>
			         	<a id="deleteOneIconLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.delete@"><span><i class="miniIcoClose"></i></span></a>
			         </li>
			         <li>
			         	<a id="baiduMapBtn" href="javascript:;" class="normalBtnIco" name="@network/topo.baiduMap@"><span><i class="miniIcoGoogle"></i></span></a>
			         </li>
			         <li><span class="topoBarLine"></span></li>
			         <li>
			         	<a id="renameLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.modifyDeviceInfo@"><span><i class="miniIcoEdit"></i></span></a>
			         </li>
			         <li><span class="topoBarLine"></span></li>
			         <li id="otherLinkLi">
			         	<a id="otherLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.function@"><span><i class="miniIcoEquipmentWithSub" style="width:28px;"></i></span></a>
			         </li>
			     </ol>
			 </div>
			 <a href="javascript:;" class="normalBtn backLinkBtn" onclick="clickBlank()"><span><i class="miniIcoArrLeft"></i>@topo.back@</span></a> 
		</div>
		<div id="onlySelectOneLine">
			<div class="noWidthCenterOuter clearBoth">
			     <ol class="upChannelListOl pB0 pT4 noWidthCenter">
			         <li>
			         	<a id="lineProperty" href="javascript:;" class="normalBtnIco" name="@topo.propertyLine@"><span><i class="miniIcoLinePro"></i></span></a>
			         </li>
			         <li>
			         	<a id="deleteOneLineLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.deleteLine@"><span><i class="miniIcoClose"></i></span></a>
			         </li>
			     </ol>
			</div>
			<a href="javascript:;" class="normalBtn backLinkBtn" onclick="clickBlank()"><span><i class="miniIcoArrLeft"></i>@topo.back@</span></a>
		...
		<div id="selectLines">
			<div class="noWidthCenterOuter clearBoth">
			     <ol class="upChannelListOl pB0 pT4 noWidthCenter">
			         <li>
			         	<a id="deleteLinesLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.deleteLine@"><span><i class="miniIcoClose"></i></span></a>
			         </li>
			     </ol>
			</div>
			<a href="javascript:;" class="normalBtn backLinkBtn" onclick="clickBlank()"><span><i class="miniIcoArrLeft"></i>@topo.back@</span></a>
		...
		<div id="selectIcons">
			<div class="noWidthCenterOuter clearBoth">
			     <ol class="upChannelListOl pB0 pT4 noWidthCenter">
			         <li>
			         	<a id="fixedManyLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.fixed@"><span><i class="miniIcoLock"></i></span></a>
			         </li>
			         <li>
			         	<a id="unFixedManyLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.unfixed@"><span><i class="miniIcoUnlock"></i></span></a>
			         </li>
			         <li><span class="topoBarLine"></span></li>
			         <li>
			         	<a id="cutManyLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.cut2@"><span><i class="miniIcoPageBorder"></i></span></a>
			         </li>
			         <li>
			         	<a id="copyManyLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.copy@"><span><i class="miniIcoCopy"></i></span></a>
			         </li>
			         <li>
			         	<a id="deleteIconsLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.delete@"><span><i class="miniIcoClose"></i></span></a>
			         </li>
			         <li><span class="topoBarLine"></span></li>
			         <li>
			         	<a id="alignLeftLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.alignLeft@"><span><i class="miniIcoAlignLeft"></i></span></a>
			         </li>
			         <li>
			         	<a id="alignCenterLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.alignMiddle@"><span><i class="miniIcoAlignCenter"></i></span></a>
			         </li>
			         <li>
			         	<a id="alignRightLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.alignRight@"><span><i class="miniIcoAlignRight"></i></span></a>
			         </li>
			         <li>
			         	<a id="valignTopLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.valignTop@"><span><i class="miniIcoValignTop"></i></span></a>
			         </li>
			         <li>
			         	<a id="valignMiddleLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.valignMiddle@"><span><i class="miniIcoValignMiddle"></i></span></a>
			         </li>
			         <li>
			         	<a id="valignBottomLinkBtn" href="javascript:;" class="normalBtnIco" name="@topo.valignBottom@"><span><i class="miniIcoValignBottom"></i></span></a>
			         </li>
			     </ol>
			</div>
			<a href="javascript:;" class="normalBtn backLinkBtn" onclick="clickBlank()"><span><i class="miniIcoArrLeft"></i>@topo.back@</span></a>
	...
	<div id="topSecondPart" class="topoSecondPart">
		<div id="toolTipTxt">@topo.toolTip@</div>
	</div>
	<div id="wrap">
		<div id="icoWrap" onselectstart="javascript:return false;" unselectable="on"></div>
		<div id="putFlash">
			<div id="putSwf"></div>
		</div>
	</div>
	...
	<div id="bubbleTip" unselectable="on" onselectstart="javascript:return false;" ></div>
	
	
	<script type="text/javascript" src="../js/ofc/swfobject.js"></script>
	<script type="text/javascript" src="../network/topoDemo.js" ></script>
	<script type="text/javascript">
	...
	var eqData = {};//设备的数据;
	var jsonData = {}//告警等的数据;
	var aSelectedLines = [];	//目前选中的线条数组;
	var aSelectedIcons = [];    //目前选中的图标数组;
	var aBubbleHtml = []; //存储hover弹出气泡的html信息;
	
	var gotoId = Number('${entityId}');//定位先选择哪一个;
	var topoFolderId = '${topoFolder.folderId}';
	var superiorFolderId = '${topoFolder.superiorId}';
	var folderPath = '${topoFolder.path}';
	var entityLabel = '${topoFolder.entityLabel}';
	var linkLabel = '${topoFolder.linkLabel}';
	var editTopoPower = <%= uc.hasPower("topoEdit") %>;//是否可以编辑，比如是否可以复制，粘贴，固定位置;
	...
	var dispatcherTimer = null;//刷新属性信息存储setInterval();
	var dispatcherInterval = '${topoFolder.refreshInterval}';//刷新时间间隔;
	var dispatcherCount = 0;//到三十，则要求刷新一次页面;
	var isSubnetMap = '${topoFolder.type}' == 5;
	var displayCluetip = ${topoFolder.displayCluetip};//是否显示气泡;
	var lineWidth = '${topoFolder.linkWidth}';//线条的宽度;	
	var lineStroke = '${topoFolder.linkColor}';//线条的颜色;
	var displayLink = '${topoFolder.displayLink}';//是否显示线条;如果不显示，那么则把透明度设置为0;
	var backgroundFlag = '${topoFolder.backgroundFlag}';//是否是网格背景;
	var backgroundImg = '${topoFolder.backgroundImg}';
	var backgroundColor = '${topoFolder.backgroundColor}';
	var displayGrid = '${topoFolder.displayGrid}';
	var backgroundPosition = '${topoFolder.backgroundPosition}';//0表示no-repeat; 1表示 no-repeat center center; 2表示repeat;
	var showType = Number('${topoFolder.showType}');//显示2是别名，1是名称,0还是ip ;
	var displayAlertIcon = ${topoFolder.displayAlertIcon};//是否显示告警;
	var displayEntityLabel = ${topoFolder.displayEntityLabel};
	var folderWidth = ${topoFolder.width};
	var folderHeight = ${topoFolder.height};
	if(folderWidth < 2000){folderWidth = 2000};//数据库中默认写的是 1600*1200,通过这种方式修正一下;
	if(folderHeight < 2000){folderHeight = 2000};
	var selObj;//存储给下拉菜单使用 extendMenu.js里面用到了;
	var backgroundRepeat;
	//设备类型;
	var USEROBJ_TYPE = { ENTITY: 1, FOLDER: 2, SHAPE: 3, LINK: 4};
	var topBarSubMenu = new Ext.menu.Menu({});
	//按钮上是否显示文字
	var topoToolView = '${topoToolView}' || 'show';
	//是否显示下级设备;
	...
	if(zoomValue.length != 1){
		...
		zoomValue = parseInt(zoomValue,10);
	}
	$(function(){
		//onu删除，发送提示信息;
	...
	function trapSendMsg(data){
		//如果地域下有这个ONU，则发送信息;
		var $onu = $('#cell'+data.entityId);
		if($onu.length == 1){
		    HeadMessage.sendMsg(data.clearMessage || data.message);
		}
	}
	
	/* function selectOneOlt(id){
		$("#icoWrap .eqContainer").removeClass("eqContainerSelected");
		var $olt = $("#cell"+id);  
		$olt.addClass("eqContainerSelected");
		
		var aSelected = [$olt],
		    flashArr = [];
		var o = {
			x: $olt.position().left + topoPic.halfIcoWidth,
			y: $olt.position().top + topoPic.halfIcoHeight
		};
		flashArr.push(o);
	...
	$(function(){
		...
		//TODO 如果存在显示下级设备;
		if(DISPLAY_SUBNET){
			$("#subDeviceConfig").addClass("normalBtnIcoSelect");
			$("#subDeviceConfig").find("i").addClass("miniIcoSubDeviceCheck");
		}else{
			$("#subDeviceConfig").find("i").addClass("miniIcoSubDeviceUncheck");
		}
		$("#subDeviceConfig").click(function(){
			var $me = $(this),
			    showSubDevice = true;
			if($me.hasClass("normalBtnIcoSelect")){//不显示下级设备;
				$me.removeClass("normalBtnIcoSelect");
				$("#subDeviceConfig").find("i").attr("class","miniIcoSubDeviceUncheck");
				showSubDevice = false;
			}else{//显示下级设备;
				$me.addClass("normalBtnIcoSelect");
				$("#subDeviceConfig").find("i").attr("class","miniIcoSubDeviceCheck");
			}
			$.ajax({
				url: '/topology/saveToolView.tv', cache:false, 
				data: {displaySubnet:showSubDevice},
				success: function() {
					refreshFn();
				}
			}); 
	...
	function refreshFn(){
		...
		/* var arr = href.split("&");
		//如果刷新的时候，src后面带了entityId信息，则就是要选中某个设备。但是点击刷新的时候又不能选中这个设备,所以要去掉&后面entityId的信息;
		if(arr.length === 2 && arr[1].slice(0,8)=='entityId'){
			href = arr[0]
		} */
		
		//先通过 ? 分隔，得到Array[1]中的内容，例如得到folderId=11&entityId=30000000001
		//通过Ext.urlDecode()将其转换为对象，如果对象中有属性entityId,则删除掉这个属性	
		//再通过Ext.urlEncode()将这个对象转换成URL编码;href就是Array[0] + 转换后的编码;
		var arr = href.split("?");
		if(arr.length > 0){
			var obj = Ext.urlDecode(arr[1]);
			if(obj.entityId){
				delete obj.entityId
			}
			var str = Ext.urlEncode(obj);
			href = arr[0] + "?" + str;
		}
	...
	function onDeleteClick(e) {
		window.top.showConfirmDlg("@COMMON.tip@", "@NETWORK.deleteEntity@", function(sConfirm) {
			...
			for(var i=0; i<len; i++){
				...
				if(topoPic.eqDataAll.folder){//子地域;
			...
			for(var j=0; j<aSelectedLines.length; j++){
				var sId = (aSelectedLines[j].id).slice(4);
			...
			$.ajax({url: 'topology/deleteCellByIds.tv', type: 'POST',
				...
				success: function(json) {
					//TODO json数据结构
					//successEntityIds, successFolderIds, successEdgeIds
					//failedEntityIds, failedFolderIds, failedEntityNames, failedFolderNames
					var eqDataAll = topoPic.eqDataAll,
					    aEqs = eqDataAll.entity,
					    aLinks = eqDataAll.link,
					    folder = eqDataAll.folder,
					    refreshLeft = false,
					    successEntityIds = json.successEntityIds || [],
					...
					//删除成功的设备;
					for(var i=0; i<successEntityIds.length; i++){
						$(".eqContainer").each(function(){
							var name = $(this).attr("name"); 
							if(name == successEntityIds[i]){
								for(var j=aEqs.length-1; j>=0; j--){
									if( name == aEqs[j].nodeId ){
										aEqs.splice(j,1);
									}
								}
								refreshLeft = true;//有设备删除了,刷新左侧，按照常理来说，是删除了olt设备才刷新的;
								$(this).remove();
							}
						})
					};
					//删除成功的线条;
					for(i=0; i<successEdgeIds.length; i++){
						for(var j=aLinks.length-1; j>=0; j--){							
							if(aLinks[j].nodeId == successEdgeIds[i]){
					...
					//删除成功的地域;
					for(i=0; i<successFolderIds.length; i++){
						$(".eqContainer").each(function(){
							var name = $(this).attr("name");
							if(name == successFolderIds[i]){
								for(var j=folder.length-1; j>=0; j--){
									if(name == folder[j].userObjId){
										folder.splice(j,1);
									}
								}
								refreshLeft = true;//有地域删除了,刷新左侧;
								$(this).remove();
							}
						});
					};
					...
					//解决问题单EMS-13080，偶然会出现某种巧合的情况。
					$("#bubbleTip, #nm3kTip").css({display:'none'});
				}
			});//end ajax;	
		});//end showConfirmDlg;
	};
	...
	function showCmcEntityMenu1(obj){
	    ...
	    items.push({text: "@NETWORK.discoveryAgain@", iconCls: 'bmenu_refresh' , handler: onDiscoveryAgainClick ,disabled:!refreshDevicePower});//刷新设备
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//列表查看;
	function onViewByDetailClick() { location.href = 'getTopoMapByFolderId.tv?viewType=detail&folderId=' + topoFolderId + '&entityId=' + gotoId + '&displaySubnet=' + DISPLAY_SUBNET; }
	//ping;
	...
	function addBaiduMap(){
		...
		if(type != "2"){
	        ...
	        window.top.createDialog('modalDlg',
					...
					'baidu/showAddEntity.tv?entityId=' + entityId + "&typeId=" + typeId + "&entityName=" + name, null, true, true);
		}
	}
	...
	function renameEntity() {
		...
		if(type != "2"){
			...
			var obj = getSelectedObj(eqId);
	        var entityId = obj.userObjId;
	        window.top.createDialog('renameEntity', "@COMMON.deviceInfo@", 600, 375,
	...
	//显示默认目录;
	function clickBlank(){
		window.aSelectedLines.length = 0; 
		window.aSelectedIcons.length = 0;
	...
	function selectOneIco(fixed){
		...
		if(type == "2"){//选中的是设备;
			$("#cutLi, #copyLi, #baiduMapBtn" ).css({display:"none"});
		}else{//选中的是地域;
			$("#cutLi, #copyLi, #baiduMapBtn").css({display:"block"});
		}
		var oldId = $(".topBarSelected").attr("id");	
		showTopMenu(oldId,"selectOneIcoPart");
		//判断类型，是否显示[设备功能]下拉菜单;
	...
	function init(){
		...
		//修改别名;
		$("#baiduMapBtn").bind("click",addBaiduMap);
		//列表查看;
	...
	function goToEntity(para){ 
		...
		firstPositionEqFn();
		//清楚所有选中线条;
    	topoPic.clearLineSelect(topoPic);
    	window.aSelectedLines.length = 0; 
		window.aSelectedIcons.length = 0;
		window.aSelectedIcons.push($(".eqContainerSelected"));
		if(para != 0){//因为gotoId一进来就Number了一下，所以没有的情况下，会是0，则不改变头部菜单;
			var oldId = $(".topBarSelected").attr("id");	
			showTopMenu(oldId,"selectOneIcoPart");	
		}
	}
	...
	**************************************/
	...
	function loadMapData(gotoId, refreshed) {
		$.ajax({url: 'loadVertexByFolderId.tv', dataType: 'json', cache: 'false',
			data: {folderId: topoFolderId, refreshed: refreshed,displaySubnet: DISPLAY_SUBNET},
			success: function(json){
				window.eqData = json;
				init();
	...
	function saveFn(){
		...
		$ico.each(function(){
			...
			x.push(parseInt( $this.position().left / topoPic.scale, 10) );
			y.push(parseInt( $this.position().top / topoPic.scale, 10) );
		})
	    ...
	    if (clipboard != null) {
			...
			if (clipboard.type == 'copy') {
				...
				$.ajax({
					...
					success: function(json) {
	                    try {
	                    	//由于左侧tree新加入了olt,粘贴的时候左侧树也必须刷新,但是粘贴的时候不能太快，必须晚点刷新页面;
							top.refreshTopoTree();
	                    	//添加新的图标和线条,暂不知道有没有图形;
	                    	refreshFn();
							/* if(json.entity){
...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	//切换olt的时候，去top层读取一下ZetaClickOltLink变量，如果该变量有值，并且界面上面有 $("#cell"+id) 则去选中;
	//有可能出现点击选显卡切换的情况，还没有设置top中ZetaClickOltLink的值，就先执行了tabActivate，所以加上setTimeout
	function tabActivate(){
		setTimeout(function(){
			var id = top.getZetaClickOltLink();
		    if(id.length > 0 && $("#cell"+id).length === 1){
		    	try{
					goToEntity(id);
					top.setZetaClickOltLink(0);//显示完后，要将top里面的变量设置成0;
				}catch(err){
	...
	//[EMS-15011]改变“固定位置”和“解锁位置”;
	function modifyFixedBtn(fixed){
		var $btn = $('#fixedBtn');
		if(fixed){ //已经是固定的，文字显示“解锁位置”
			$btn.html('<span><i class="miniIcoUnlock"></i>@GRAPH.unfixLocation@</span>');
		}else{
			$btn.html('<span><i class="miniIcoLock"></i>@GRAPH.fixLocation@</span>');
		}
	}
/////////////////////////////////////////////////////////////////////////////////////////////
	</script>

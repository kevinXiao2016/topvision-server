...
public class RepeatedlyLogonException extends ServiceException {
    private static final long serialVersionUID = -4703549922292201968L;
     ...
     */
    public RepeatedlyLogonException() {
    }
     ...
     */
    public RepeatedlyLogonException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public RepeatedlyLogonException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public RepeatedlyLogonException(Throwable cause) {
        super(cause);
    }
}

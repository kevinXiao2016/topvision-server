...
public class MonitorCreateException extends ServiceException {
    private static final long serialVersionUID = 7227926127798215947L;
     ...
     */
    public MonitorCreateException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public MonitorCreateException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public MonitorCreateException(Throwable cause) {
        super(cause);
    }
}

...
public class LimitIpLogonException extends ServiceException {
    private static final long serialVersionUID = 3451647882853246251L;
     ...
     */
    public LimitIpLogonException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public LimitIpLogonException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public LimitIpLogonException(Throwable cause) {
        super(cause);
    }
}

...
public class MonitorExistException extends ServiceException {
    private static final long serialVersionUID = -5238803473051970624L;
     ...
     */
    public MonitorExistException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public MonitorExistException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public MonitorExistException(Throwable cause) {
        super(cause);
    }
}

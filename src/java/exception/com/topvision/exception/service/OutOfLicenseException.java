...
public class OutOfLicenseException extends ServiceException {
    private static final long serialVersionUID = 3122079010588555351L;
     ...
     */
    public OutOfLicenseException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public OutOfLicenseException(String message, Throwable cause) {
        super(message, cause);
    }

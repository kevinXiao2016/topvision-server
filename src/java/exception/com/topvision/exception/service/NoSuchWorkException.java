...
public class NoSuchWorkException extends ServiceException {
    private static final long serialVersionUID = 4950586668853611248L;
     ...
     * @since 1.4
     */
    public NoSuchWorkException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public NoSuchWorkException(Throwable cause) {
        super(cause);
    }
}
...
public class NowIsWorkingException extends ServiceException {
    private static final long serialVersionUID = 3674798853052965274L;
     ...
     */
    public NowIsWorkingException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public NowIsWorkingException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public NowIsWorkingException(Throwable cause) {
        super(cause);
    }
}
...
public class EngineUnlinkException extends EngineException {
    private static final long serialVersionUID = -5285360317432513232L;
     ...
     */
    public EngineUnlinkException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public EngineUnlinkException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public EngineUnlinkException(Throwable cause) {
        super(cause);
    }
}
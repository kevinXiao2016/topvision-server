...
public class UnknownIndexException extends EngineException {
    private static final long serialVersionUID = 3375902709572628829L;
     ...
     * @since 1.4
     */
    public UnknownIndexException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public UnknownIndexException(Throwable cause) {
        super(cause);
    }
}
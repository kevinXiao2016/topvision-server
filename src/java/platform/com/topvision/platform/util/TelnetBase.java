/***********************************************************************
 * $Id: TelnetBase.java,v1.0 2017年1月8日 上午10:18:30 $
 * 
 * @author: vanzand
 * 
...
public class TelnetBase {
    ...
    public static String[] failTags = { "Failed", "fail", "incorrect", "Please complete the input within 5 seconds.",
            "%Login authentication failed. Too many failures." };
    public static String[] connectTags = { "Username:", "username:", "assword" };
    public static String[] loginTags = { "$", "#", ">", "ogin", "@" };
    public static String[] commondEndTags = { "$", "#", ">" };
    public static String[] pwdResponseTags = { "$", "#", ">", "assword:", "Please complete the input within 5 seconds.",
            "%Login authentication failed. Too many failures.", "Bad passwords, too many failures!" };
    public static String[] allTags = { "Username:", "Password:", "--More--", "Failed", "fail", "incorrect", "$", "#",
            ">", "ogin", "@", "Please complete the input within 5 seconds.",
            "%Login authentication failed. Too many failures." };
    ...
    public String connect() throws Exception {
        ...
        return readKeyWords(connectTags);
    }
    ...
    public String sendUserName(String name) throws Exception {
        ...
        return readKeyWords("assword:", "Please complete the input within 5 seconds.");
    }
    ...
    public String sendUserPwd(String pwd) throws Exception {
        ...
        return readKeyWords(pwdResponseTags);
    }
    ...
    public String sendHelpCommand(String cmd, long timeOut) throws Exception {

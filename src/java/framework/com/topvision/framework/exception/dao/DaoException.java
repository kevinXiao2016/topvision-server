package com.topvision.framework.exception.dao;

import com.topvision.framework.exception.TopvisionRuntimeException;

public class DaoException extends TopvisionRuntimeException {
    private static final long serialVersionUID = -8208326049622187836L;

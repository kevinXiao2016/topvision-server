 ...
 */
package com.topvision.framework.dubbo;
...
public class ReferenceConfigCache {
    ...
    public static ConcurrentMap<String, ReferenceConfigCache> getCacheHolders() {
        return cacheHolder;
    }
    ...
    public ConcurrentMap<String, ReferenceConfig<?>> getCaches() {
        return cache;
    }

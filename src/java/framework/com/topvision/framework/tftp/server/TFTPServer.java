...
public class TFTPServer {
    ...
    /**
     * This constructor needs a VirtualFileSystem to get in or output streams for a file.
     * 
     * @param vfs
     *            An implementing virtual file system
     */
    ...
    public void start() {
        ...
        server.setName("TFTPServerSocket");
        server.start();
    }

    public void stop() {
        if (ss == null) {
            tftpLog.warn("ServerSocket is already null so, is tftpServer closed???");
            return;
        }

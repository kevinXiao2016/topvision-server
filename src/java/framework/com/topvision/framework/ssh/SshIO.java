...
public abstract class SshIO {
    ...
    /**
     * Debug level. This results in additional diagnostic messages on the java console.
     */
    ...
    private String handlePacket1(SshPacket1 p) throws IOException { // the
        ...
        case SSH_MSG_DEBUG:
            ...
            if (debug > 0) {
                ...
                // just USER CMS.
                /*
                 * if(lastPacketSentType==SSH_CMSG_USER) { Send_SSH_CMSG_AUTH_PASSWORD(); break; }
                 */
                return str;
            }
            return "";
    ...
    private String handlePacket2(SshPacket2 p) throws IOException {
        ...
        case SSH2_MSG_KEXDH_REPLY: {
            ...
            /*
             * the blob has a substructure: String type if RSA: bignum1 bignum2 if DSA:
             * bignum1,2,3,4
             */
    ...
    /**
     * Send_SSH_CMSG_EXEC_SHELL (no arguments) Starts a shell (command interpreter), and enters
    ...
    /**
     * Send_SSH_CMSG_REQUEST_PTY string TERM environment variable value (e.g. vt100) 32-bit int
     * terminal height, rows (e.g., 24) 32-bit int terminal width, columns (e.g., 80) 32-bit int
     * terminal width, pixels (0 if no graphics) (e.g., 480)
     */
    ...
    /**
     * Send_SSH_CMSG_WINDOW_SIZE string TERM environment variable value (e.g. vt100) 32-bit int
     * terminal height, rows (e.g., 24) 32-bit int terminal width, columns (e.g., 80) 32-bit int
     * terminal width, pixels (0 if no graphics) (e.g., 480)
     */

...
import com.topvision.framework.common.Wrapper;

/**
 * The telnet ssh is a sample class for how to use the SSH protocol handler of the JTA source
 * package. To write a program using the wrapper you may use the following piece of code as an
 * example:
 * 
 * <PRE>
 ...
 * </PRE>
 * 
 * Please keep in mind that the password is visible for anyone who can download the class file. So
 * use this only for public accounts or if you are absolutely sure nobody can see the file.
 * <P>
...
public class SshWrapper extends Wrapper {
     ...
     * (non-Javadoc)
     * 
     * @see com.topvision.framework.common.ems.engine.util.Wrapper#login(java.lang.String,
     *      java.lang.String)
     */
    @Override
    ...
    /**
     * Read data from the backend and decrypt it. This is a buffering read as the encrypted
     * information is usually smaller than its decrypted pendant. So it will not read from the
     * backend as long as there is data in the buffer.
     * 
     * @param b

...
public class Wrapper {
    ...
    public void disconnect() throws IOException {
        if (logger.isDebugEnabled()) {
            logger.debug("Wrapper: disconnect()");
        }
        if (socket != null)
            socket.close();
    }
    ...
    /**
     * Login into remote host. This is a convenience method and only works if the prompts are
     * "login:" and "Password:".
     * 
     * @param user
     *            the user name
    ...
    /**
     * Wait for a string to come from the remote host and return all that characters that are
     * received until that happens (including the string being waited for).
     * 
     * @param match

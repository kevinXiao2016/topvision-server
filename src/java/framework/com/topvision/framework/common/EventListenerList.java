 ...
 * 
 * The main benefits that this class provides are that it is relatively cheap in the case of no
...
public class EventListenerList implements Serializable {
    private static final long serialVersionUID = -7825617236279565997L;
     ...
     * listener data is stored internally! This method is guaranteed to pass back a non-null array,
     * so that no null-checking is required in fire methods. A zero-length array of Object should be
     ...
     * if any such manipulation is necessary, it should be done on a copy of the array returned

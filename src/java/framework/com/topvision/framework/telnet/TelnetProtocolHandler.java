...
/**
 * This is a telnet protocol handler. The handler needs implementations for several methods to
 * handle the telnet options and to be able to read and write the buffer.
 * <P>
...
public abstract class TelnetProtocolHandler {
    ...
    /**
     * Handle telnet protocol negotiation. The buffer will be parsed and necessary actions are taken
     * according to the telnet protocol. See <A HREF="RFC-Telnet-URL">RFC-Telnet</A>
     * 
     * @param nbuf
    ...
    /**
     * Reset the protocol handler. This may be necessary after the connection was closed or some
    ...
    /**
     * Do not send any notifications at startup. We do not know, whether the remote client
     * understands telnet protocol handling, so we are silent. (This used to send IAC WILL SGA, but
     * this is false for a compliant client.)
     */
    public void startup() throws IOException {
    }

    /**
     * Transpose special telnet codes like 0xff or newlines to values that are compliant to the
     * protocol. This method will also send the buffer immediately after transposing the data.
     * 
     * @param buf

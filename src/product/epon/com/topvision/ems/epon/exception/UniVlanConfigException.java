/***********************************************************************
 * $Id: UniVlanConfigException.java,v1.0 2011-10-30 上午08:55:59 $
 * 
 * @author: lizongtian
 * 
 ...
 * 
 */
public class UniVlanConfigException extends ServiceException {

    private static final long serialVersionUID = 8483399436947443952L;
     ...
     */
    public UniVlanConfigException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public UniVlanConfigException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public UniVlanConfigException(Throwable cause) {
        super(cause);
    }

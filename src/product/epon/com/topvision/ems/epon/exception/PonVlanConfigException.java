/***********************************************************************
 * $Id: PonVlanConfigException.java,v1.0 2011-10-28 下午03:18:59 $
 * 
 ...
 * 
 */
public class PonVlanConfigException extends ServiceException {
     ...
     */
    public PonVlanConfigException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public PonVlanConfigException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public PonVlanConfigException(Throwable cause) {
        super(cause);
    }
}

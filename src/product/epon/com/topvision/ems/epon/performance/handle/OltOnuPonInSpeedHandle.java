/***********************************************************************
 * $Id: OltOnuPonInSpeedHandle.java,v1.0 2013-9-3 下午03:51:12 $
 * 
 * @author: Rod John
 * 
...
/**
 * @author Rod John
 * @created @2013-9-3-下午03:51:12
 * 
 */
@Service("oltOnuPonInSpeedHandle")
public class OltOnuPonInSpeedHandle extends PerformanceHandle {
    public static String OLT_ONUPON_IN_SPEED_FLAG = "OLT_ONUPON_IN_SPEED";
    public static Integer OLT_ONUPON_IN_ALERT_ID = -718;
    public static Integer OLT_ONUPON_IN_EVENT_ID = -719;
    ...
    public PerfThresholdEventParams getEventParams(PerformanceData data) {
        ...
        param.setAlertEventId(OLT_ONUPON_IN_ALERT_ID);
        param.setClearEventId(OLT_ONUPON_IN_EVENT_ID);
        ...
        param.setTargetId(OLT_ONUPON_IN_SPEED_FLAG);
        param.setTargetIndex(flowPerf.getPortIndex());
        param.setMessage("OLT[" + getHost(data.getEntityId()) + "] port " + param.getSource() + "_"
                + getString("PerformanceAlert.onuPonInRate", "epon") + "[" + df.format(flowPerf.getPortInSpeedUnitM())
                + "Mbps]");
        return param;
    }
    ...
    public void initialize() {
        performanceStatisticsCenter.registerPerformanceHandler(OLT_ONUPON_IN_SPEED_FLAG, this);
    }
    ...
    @PreDestroy
    public void destroy() {
        performanceStatisticsCenter.unregisterPerformanceHandler(OLT_ONUPON_IN_SPEED_FLAG);
    }
    ...
    public String getTypeCode(PerformanceData data) {
        return OLT_ONUPON_IN_SPEED_FLAG;
    }

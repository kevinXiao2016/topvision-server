 ...
 */
@Scope("prototype")
@Service("onuLinkQualityPerf")
public class OnuLinkQualityPerf extends OperClass {
    private static final long serialVersionUID = -6417920735622717737L;
    private Long onuId;
    private Long onuIndex;
    private String onuEorG;
    private Boolean isNecessary = false;

    public OnuLinkQualityPerf() {
        super("onuLinkQualitySaver", "onuLinkQualityScheduler", "onuLinkQualityPerf");
    }

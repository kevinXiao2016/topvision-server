/***********************************************************************
 * $Id: OltOnuPonOutSpeedHandle.java,v1.0 2013-9-3 下午03:51:29 $
 * 
 * @author: Rod John
 * 
...
/**
 * @author Rod John
 * @created @2013-9-3-下午03:51:29
 * 
 */
@Service("oltOnuPonOutSpeedHandle")
public class OltOnuPonOutSpeedHandle extends PerformanceHandle {
    public static String OLT_ONUPON_OUT_SPEED_FLAG = "OLT_ONUPON_OUT_SPEED";
    public static Integer OLT_ONUPON_OUT_SPEED_ALERT_ID = -720;
    public static Integer OLT_ONUPON_OUT_SPEED_EVENT_ID = -721;
    ...
    public PerfThresholdEventParams getEventParams(PerformanceData data) {
        ...
        param.setAlertEventId(OLT_ONUPON_OUT_SPEED_ALERT_ID);
        param.setClearEventId(OLT_ONUPON_OUT_SPEED_EVENT_ID);
        ...
        param.setTargetId(OLT_ONUPON_OUT_SPEED_FLAG);
        param.setTargetIndex(flowPerf.getPortIndex());
        param.setMessage("OLT[" + getHost(data.getEntityId()) + "] port " + param.getSource() + "_"
                + getString("PerformanceAlert.onuPonOutRate", "epon") + "["
                + df.format(flowPerf.getPortOutSpeedUnitM()) + "Mbps]");
        return param;
    }
    ...
    public void initialize() {
        performanceStatisticsCenter.registerPerformanceHandler(OLT_ONUPON_OUT_SPEED_FLAG, this);
    }
    ...
    @PreDestroy
    public void destroy() {
        performanceStatisticsCenter.unregisterPerformanceHandler(OLT_ONUPON_OUT_SPEED_FLAG);
    }
    ...
    public String getTypeCode(PerformanceData data) {
        return OLT_ONUPON_OUT_SPEED_FLAG;
    }

 ...
 * 
 */
@Service("oltSniPortOutUsedHandle")
public class OltSniPortOutUsedHandle extends PerformanceHandle {
    public static String SNI_OUTUSED_FLAG = "OLT_SNI_OUT_USED";
    public static Integer SNI_OUTUSED_ALERT_ID = -766;
    public static Integer SNI_OUTUSED_EVENT_ID = -765;
    ...
    public PerfThresholdEventParams getEventParams(PerformanceData data) {
        ...
        param.setAlertEventId(SNI_OUTUSED_ALERT_ID);
        param.setClearEventId(SNI_OUTUSED_EVENT_ID);
    ...
    public void initialize() {
        performanceStatisticsCenter.registerPerformanceHandler(SNI_OUTUSED_FLAG, this);
    }
    ...
    @PreDestroy
    public void destroy() {
        performanceStatisticsCenter.unregisterPerformanceHandler(SNI_OUTUSED_FLAG);
    }

...
@Repository("oltPerfDao")
public class OltPerfDaoImpl extends MyBatisDaoSupport<OltPerfThreshold> implements OltPerfDao {
     ...
     * 
     * @see
     * com.topvision.ems.epon.performance.dao.OltPerfDao#updateSlotStatusWithServiceQuality(java
     * .util.List)
     */
    @Override

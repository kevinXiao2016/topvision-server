/***********************************************************************
 * $Id: OnuCpeLocation.java,v1.0 2017-11-8 上午9:22:40 $
 * 
 * @author: lzt
 * 
...
/**
 * @author lzt
 * @created @2017-11-8-上午9:22:40
 *
 */
public class OnuCpeLocationImprove implements AliasesSuperType {

    private static final long serialVersionUID = 417443384991850073L;
    ...
    @SnmpProperty(oid = "1.3.6.1.4.1.32285.11.2.3.1.8.4.1.6", type = "Integer32")
    private Integer gemPortId;
    @SnmpProperty(oid = "1.3.6.1.4.1.32285.11.2.3.1.8.4.1.7", type = "Integer32")
    ...
    public String getUniDisplay() {
        return String.format("%s/%s:%s:%s:%s:%s", slotLocation, portLocation, onuLocation, uniLocation, gemPortId,
                svlan);
    }

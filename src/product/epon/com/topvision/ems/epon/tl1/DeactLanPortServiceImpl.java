 ...
 *
 */
@TL1CommandCode(code = TL1Constant.DEACTIVATE_LANPORT)
@Service("deactLanPortService")
public class DeactLanPortServiceImpl implements TL1ExecutorService<Object> {
     ...
     */
    @Override
    public void execute(Long entityId, Long index, Object config) {
        Long uniId = uniDao.getUniIdByIndex(entityId, index);
        uniService.setUniAdminStatus(entityId, uniId, EponConstants.PORT_STATUS_DOWN);
    }

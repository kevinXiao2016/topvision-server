/***********************************************************************
 * $Id: PortLinkUpTrapExecute.java,v1.0 2017年1月14日 上午9:13:59 $
 * 
 * @author: lizongtian
 * 
...
/**
 * @author lizongtian
 * @created @2017年1月14日-上午9:13:59
 *
 */
@Service("PortLinkUpTrapExcute")
@EventExecute(code = "event.code.{EponCode.PORT_LINK_UP}")
public class PortLinkUpTrapExecute extends BaseService implements TrapExceutor {

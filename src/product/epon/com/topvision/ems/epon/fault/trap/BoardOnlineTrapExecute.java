/***********************************************************************
 * $Id: BoardOnlineTrapExecute.java,v1.0 2017年1月9日 上午10:27:41 $
 * 
 * @author: lizongtian
 * 
...
/**
 * @author lizongtian
 * @created @2017年1月9日-上午10:27:41
 *
 */
@Service("BoardOnlineTrapExecute")
@EventExecute(code = "event.code.{EponCode.BD_ONLINE}")
public class BoardOnlineTrapExecute extends BaseService implements TrapExceutor {
    @Autowired
    ...
    public void execute(TrapEvent evt) {
        ...
        String source = evt.getSource(); // SLOT:2
        Long slotIndex = EponIndex.getSlotIndex(Integer.parseInt(source.split(":")[1]));

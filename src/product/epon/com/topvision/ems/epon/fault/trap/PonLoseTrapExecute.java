/***********************************************************************
 * $Id: PonLoseTrapExecute.java,v1.0 2017年1月11日 下午4:21:31 $
 * 
 * @author: lizongtian
 * 
...
/**
 * @author lizongtian
 * @created @2017年1月11日-下午4:21:31
 *
 */
@Service("PonLoseTrapExecute")
@EventExecute(code = "event.code.{EponCode.PORT_PON_LOS}")
public class PonLoseTrapExecute extends BaseService implements TrapExceutor {

 ...
 * 
 */
@Alias(value = "oltSniStormInfo")
public class OltSniStormSuppressionEntry implements Serializable, AliasesSuperType {
    private static final long serialVersionUID = 536257125555471803L;
    private Long entityId;
    private Long sniId;
    private Long sniIndex;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.1", index = true)
    private Integer bsDeviceIndex;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.2", index = true)
    private Long bsCardIndex;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.3", index = true)
    private Integer bsPortIndex;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.4", writable = true, type = "Integer32")
    private Integer unicastStormEnable;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.5", writable = true, type = "Integer32")
    private Integer unicastStormInPacketRate;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.6", writable = true, type = "Integer32")
    private Integer unicastStormOutPacketRate;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.7", writable = true, type = "Integer32")
    private Integer multicastStormEnable;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.8", writable = true, type = "Integer32")
    private Integer multicastStormInPacketRate;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.9", writable = true, type = "Integer32")
    private Integer multicastStormOutPacketRate;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.10", writable = true, type = "Integer32")
    private Integer broadcastStormEnable;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.11", writable = true, type = "Integer32")
    private Integer broadcastStormInPacketRate;
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.3.2.5.1.12", writable = true, type = "Integer32")
    ...
    public Long getSniIndex() {
        if (sniIndex == null) {
            sniIndex = EponIndex.getSniIndex(bsCardIndex.intValue(), bsPortIndex);
        }
        return sniIndex;
    }
    ...
    public void setSniIndex(Long sniIndex) {
        ...
        bsDeviceIndex = 1;
        bsCardIndex = EponIndex.getSlotNo(sniIndex);
        bsPortIndex = EponIndex.getSniNo(sniIndex).intValue();
    }
    ...
    public String toString() {
        ...
        builder.append("OltSniStormSuppressionEntry [entityId=");

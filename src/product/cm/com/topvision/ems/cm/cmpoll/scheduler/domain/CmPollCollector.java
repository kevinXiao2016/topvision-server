 ...
 ***********************************************************************/
package com.topvision.ems.cm.cmpoll.scheduler.domain;
 ...
 *
 */
@Alias("cmPollCollector")
public class CmPollCollector implements Serializable, AliasesSuperType, Comparable<CmPollCollector> {
    private static final long serialVersionUID = -420336880881481963L;
    private Logger logger = LoggerFactory.getLogger(CmPollCollector.class);
    ...
    @Override
    public int compareTo(CmPollCollector other) {

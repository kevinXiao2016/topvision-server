 ...
 ***********************************************************************/
package com.topvision.ems.cmts.performance.engine;
...
public interface CmtsPerfDao {
    ...
    //Modify by Victor@20150618原来是PerformanceDao中方法，CmtsFlowQualityScheduler通过回调Server调用，改为engine 到调用
    List<Long> getUpLinkIndex(Long entityId);

    List<Long> getUpChannelIndex(Long cmcId);

    List<Long> getDownChannelIndex(Long cmcId);
}
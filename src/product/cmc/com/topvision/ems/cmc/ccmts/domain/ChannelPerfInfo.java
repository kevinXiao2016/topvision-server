 ...
 * 
 */
@Alias("channelPerfInfo")
public class ChannelPerfInfo implements Serializable, AliasesSuperType {
    ...
    public void setChannelIndex(Long channelIndex) {
        ...
        //jay 修改channel的获取方式 屏蔽掉通过channelIndex获取的方式
//        setChannelType(CmcIndexUtils.getChannelType(channelIndex).intValue());
    ...
    public void setChannelInOctetsRate(float channelInOctetsRate) {
        ...
        //与李纵天沟通过  channelInOctetsRateString这个属性计算出来的结果是错误的切换为与现在算法一致的方法
        channelInOctetsRateString = NumberUtils.getIfSpeedStr(channelOutOctetsRate);
    ...
    public void setChannelOutOctetsRate(float channelOutOctetsRate) {
        ...
        //与李纵天沟通过  channelOutOctetsRateString这个属性计算出来的结果是错误的切换为与现在算法一致的方法
        channelOutOctetsRateString = NumberUtils.getIfSpeedStr(channelOutOctetsRate);
    }

...
public interface CmcPerfDao {
     ...
     */
    void updateCmcStatus(CmcServiceQuality cmcServiceQuality);
     ...
     * 更新CMC光机温度性能数据
     * 
     * @param cmcDorOptTempQuality
     * @return
     */
    void insertCmcDorOptTempQuality(CmcDorOptTempQualityPerfResult cmcDorOptTempQualityPerfResult);

    /**
     * 更新CMC光机电压性能数据
     * 
     * @param cmcDorLinePowerQuality
     * @return
     */
    void insertCmcDorLinePowerQuality(CmcDorLinePowerQualityPerfResult cmcDorLinePowerQualityPerfResult);

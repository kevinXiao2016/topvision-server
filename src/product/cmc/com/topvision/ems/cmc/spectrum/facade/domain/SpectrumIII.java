 ...
 * @author bryan
 */
@Alias("cmcSpectrumIII")
public class SpectrumIII extends OperClass implements Serializable, AliasesSuperType {
    ...
    public SpectrumIII() {
        super(null, "spectrumIIIPerfScheduler", "CC_CCSPECTRUM");
    }

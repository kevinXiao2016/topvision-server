...
public class SpectrumIIHandle extends PerformanceHandle {
    ...
    public void handle(PerformanceData data) {
        ...
        SpectrumIIResult spectrumResult = (SpectrumIIResult) data.getPerfData();
        logger.debug("SpectrumIIHandle identifyKey[" + spectrumResult.getDomain().getIdentifyKey() + "] exec start.");
        SpectrumIIData spectrum = spectrumResult.getSpectrumIIData();
        ...
        if (spectrum != null) {
            ...
            spectrumIIDataParse.setSrcData(spectrum.getDataBuffer());

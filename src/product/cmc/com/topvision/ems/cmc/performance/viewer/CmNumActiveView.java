/***********************************************************************
 * $Id: CmNumActiveView.java,v1.0 2012-7-19 下午04:23:09 $
 * 
 * @author: dosion
 * 
 ...
 *
 */
public class CmNumActiveView  extends AbstractView  implements Serializable {
    private static final long serialVersionUID = 8590922795476527551L;
    
    public String getViewerType() {
        return "cmNumActive";    //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public List<Point> read(ViewerParam viewerParam) {
        return cmcPerfDao.cmNumActiveRead(viewerParam);
    }

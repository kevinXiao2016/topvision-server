/***********************************************************************
 * $Id: CmNumTotalView.java,v1.0 2012-7-19 下午04:04:36 $
 * 
 * @author: dosion
 * 
 ...
 *
 */
public class CmNumTotalView extends AbstractView implements Serializable {
    private static final long serialVersionUID = 5429505845639264596L;
    
    public String getViewerType() {
        return "cmNumTotal";    //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public List<Point> read(ViewerParam viewerParam) {
        return cmcPerfDao.cmNumTotalRead(viewerParam);
    }

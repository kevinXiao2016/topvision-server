/***********************************************************************
 * $Id: CmcUpLinkOutUsedHandle.java,v1.0 2013-9-3 下午02:53:05 $
 * 
 * @author: lizongtian
 * 
...
/**
 * @author lizongtian
 * @created @2013-9-3-下午02:53:05
 * 
 */
@Service("cmcUpLinkOutUsedHandle")
public class CmcUpLinkOutUsedHandle extends CmcPerformanceHandle {

    public static String CC_UPLINK_OUT_UESD_FLAG = "CC_UPLINK_OUT_UESD";
    public static Integer CC_UPLINK_OUT_UESD_ALERT_ID = -820;
    public static Integer CC_UPLINK_OUT_UESD_EVENT_ID = -821;
    ...
    public PerfThresholdEventParams getEventParams(PerformanceData data) {
        if (data.getPerfData() instanceof CmcFlowQuality) {
            ...
            param.setAlertEventId(CC_UPLINK_OUT_UESD_ALERT_ID);
            param.setClearEventId(CC_UPLINK_OUT_UESD_EVENT_ID);
            param.setSource(result.getIfIndex().toString());
            if (result.getIfOutUsed() == null || result.getIfOutUsed() >= 100) {
                return null;
            }
            Float upLinkUsed = Float.parseFloat(result.getIfOutUsed().toString());
            String maxMes = "";
            ...
            String realRate = df.format(result.getIfOutSpeed() / 1000 / 1000);
            param.setPerfValue(upLinkUsed);
            param.setTargetId(CC_UPLINK_OUT_UESD_FLAG);
    ...
    public void initialize() {
        performanceStatisticsCenter.registerPerformanceHandler(CC_UPLINK_OUT_UESD_FLAG, this);
    }
    ...
    @Override
    public void destroy() {
        performanceStatisticsCenter.unregisterPerformanceHandler(CC_UPLINK_OUT_UESD_FLAG);
    }
    ...
    public String getTypeCode(PerformanceData data) {
        return CC_UPLINK_OUT_UESD_FLAG;
    }

/***********************************************************************
 * $Id: CmNumOnlineView.java,v1.0 2012-7-19 下午04:20:55 $
 * 
 * @author: dosion
 * 
 ...
 *
 */
public class CmNumOnlineView extends AbstractView implements Serializable {
    private static final long serialVersionUID = -7830576529994927680L;

    public String getViewerType() {
        return "cmNumOnline";    //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public List<Point> read(ViewerParam viewerParam) {
        return cmcPerfDao.cmNumOnlineRead(viewerParam);
    }

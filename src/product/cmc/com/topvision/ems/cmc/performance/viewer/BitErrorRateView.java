/***********************************************************************
 * $Id: BitErrorRateView.java,v1.0 2012-7-19 下午02:16:57 $
 * 
 * @author: dosion
 * 
...
/**
 * @author dosion
 * @created @2012-7-19-下午02:16:57
 *
 */
public class BitErrorRateView extends AbstractView {
    public String getViewerType() {
        return "bitErrorRate"; //To change body of implemented methods use File | Settings | File Templates.
    }

    public String getViewerName() {
        return ResourcesUtil.getString("CCMTS.view.bitErrorRate.name"); //To change body of implemented methods use File | Settings | File Templates.
    }

    public String getViewerUnit() {
        return ResourcesUtil.getString("CCMTS.view.bitErrorRate.unit"); //To change body of implemented methods use File | Settings | File Templates.
    }

    public String getYTitle() {
        return ResourcesUtil.getString("CCMTS.view.bitErrorRate.ytitle"); //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public List<Point> read(ViewerParam viewerParam) {
        List<Point> points = cmcPerfDao.bitErrorRateRead(viewerParam);

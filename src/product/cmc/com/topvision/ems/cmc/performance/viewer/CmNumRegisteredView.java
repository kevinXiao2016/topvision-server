/***********************************************************************
 * $Id: CmNumRegisteredView.java,v1.0 2012-7-19 下午04:43:07 $
 * 
 * @author: dosion
 * 
...
/**
 * @author dosion
 * @created @2012-7-19-下午04:43:07
 *
 */
public class CmNumRegisteredView extends AbstractView implements Serializable {
    private static final long serialVersionUID = -1131853074336829949L;
    
    public String getViewerType() {
        return "cmNumRegistered";    //To change body of implemented methods use File | Settings | File Templates.
    }

    public String getViewerName() {
        return ResourcesUtil.getString("CCMTS.view.cmNumRegisted.name");    //To change body of implemented methods use File | Settings | File Templates.
    }

    public String getViewerUnit() {
        return ResourcesUtil.getString("CCMTS.view.cmNumRegisted.unit"); //To change body of implemented methods use File | Settings | File Templates.
    }

    public String getYTitle() {
        return ResourcesUtil.getString("CCMTS.view.cmNumRegisted.ytitle");    //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public List<Point> read(ViewerParam viewerParam) {
        return cmcPerfDao.cmNumRegisteredRead(viewerParam);
    }

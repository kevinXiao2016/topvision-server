/***********************************************************************
 * $Id: SetValueFailException.java,v1.0 2011-11-1 上午09:35:25 $
 * 
 * @author: loyal
 * 
...
/**
 * @author loyal
 * @created @2011-11-1-上午09:35:25
 * 
 */
public class SetValueFailException extends ServiceException {
    private static final long serialVersionUID = 7885990775408833358L;
     ...
     */
    public SetValueFailException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public SetValueFailException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public SetValueFailException(Throwable cause) {
        super(cause);
    }

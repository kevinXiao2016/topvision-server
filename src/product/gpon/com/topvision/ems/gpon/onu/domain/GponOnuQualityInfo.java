...
public class GponOnuQualityInfo implements Serializable, AliasesSuperType {
    ...
    @SnmpProperty(oid = "1.3.6.1.4.1.17409.2.8.4.1.1.14", type = "OctetString")
    ...
    public String toString() {
        return "OnuQualityInfo [entityId=" + entityId + ", onuId=" + onuId + ", onuDeviceIndex=" + onuDeviceIndex
                + ", onuHardwareVersion=" + onuHardwareVersion + ", onuOperationStatus=" + onuOperationStatus
